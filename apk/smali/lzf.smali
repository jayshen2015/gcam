...
.field private b:Llzz;

.field private final c:Lmbo;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0, v1}, Lmbo;-><init>(Llzf;I)V

    iput-object v0, p0, Llzf;->c:Lmbo;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Llzf;->a:Ljava/lang/Object;

    return-void
.end method

.method private final a()Llzz;
    .locals 2

    iget-object v0, p0, Llzf;->a:Ljava/lang/Object;
...
# virtual methods
.method public abstract c(Ljava/lang/String;[B[BLlze;Lqlg;)V
.end method
...
.method public final onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    invoke-direct {v0, p1}, Lmaa;-><init>(Ljava/lang/String;)V
    ...
    sget-object v3, Lmap;->b:Lmap;

    invoke-static {p0, v1, v3}, Lmae;->a(Landroid/content/Context;Ljava/lang/String;Lmad;)Landroid/os/IInterface;

    move-result-object v1

    check-cast v1, Llzz;
    :try_end_1
    .catch Lmac; {:try_start_1 .. :try_end_1} :catch_1
    ...
    iget-object v4, p0, Llzf;->c:Lmbo;

    invoke-virtual {v1}, Lebg;->a()Landroid/os/Parcel;

    move-result-object v5

    invoke-static {v5, v3}, Lebi;->d(Landroid/os/Parcel;Landroid/os/IInterface;)V

    invoke-static {v5, v4}, Lebi;->d(Landroid/os/Parcel;Landroid/os/IInterface;)V

    const/4 v3, 0x1

    invoke-virtual {v1, v3, v5}, Lebg;->z(ILandroid/os/Parcel;)V
    :try_end_2
    ...
    invoke-direct {p1, v1}, Lmaa;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v0, p1}, Lebi;->c(Landroid/os/Parcel;Landroid/os/Parcelable;)V

    const/4 p1, 0x3

    invoke-virtual {v1, p1, v0}, Lebg;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {p1, v0}, Lmaa;-><init>(Ljava/lang/String;)V
...
.method public final onDestroy()V
    ...
    invoke-virtual {v0, v2, v1}, Lebg;->z(ILandroid/os/Parcel;)V
    :try_end_0
...
.method public final onRebind(Landroid/content/Intent;)V
    ...
    invoke-static {v1, p1}, Lebi;->c(Landroid/os/Parcel;Landroid/os/Parcelable;)V
...
.method public final onUnbind(Landroid/content/Intent;)Z
    ...
    invoke-static {v2, p1}, Lebi;->c(Landroid/os/Parcel;Landroid/os/Parcelable;)V

    invoke-virtual {v0, v1, v2}, Lebg;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    sget-object v2, Ljava/nio/channels/HpWg/IWCkMFOfL;->iMYmoF:Ljava/lang/String;
