...
.method public constructor <init>(Landroid/widget/CompoundButton;)V
    ...
    iput-object v0, p0, Lir;->a:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object p1, p0, Lir;->d:Landroid/widget/CompoundButton;
...
.method public final a()V
    ...
    iget-object v0, p0, Lir;->d:Landroid/widget/CompoundButton;

    invoke-static {v0}, Lcfy;->a(Landroid/widget/CompoundButton;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Lir;->a:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v1, p0, Lir;->d:Landroid/widget/CompoundButton;
...
.method final b(Landroid/util/AttributeSet;I)V
    ...
    iget-object v3, p0, Lir;->d:Landroid/widget/CompoundButton;

    invoke-virtual {v3}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v4

    sget-object v5, Lfw;->m:[I
    ...
    invoke-virtual {v0, p1, v2}, Landroidx/wear/ambient/AmbientDelegate;->t(II)I
    ...
    :try_start_1
    iget-object p2, p0, Lir;->d:Landroid/widget/CompoundButton;

    invoke-virtual {p2}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-static {v1, p1}, Lfx;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v2, v2}, Landroidx/wear/ambient/AmbientDelegate;->t(II)I
    ...
    invoke-static {p2, p1}, Lcfx;->c(Landroid/widget/CompoundButton;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1, v1}, Landroidx/wear/ambient/AmbientDelegate;->q(II)I

    move-result p1

    const/4 v1, 0x0

    invoke-static {p1, v1}, La;->l(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p1

    invoke-static {p2, p1}, Lcfx;->d(Landroid/widget/CompoundButton;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_2
