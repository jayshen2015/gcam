...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lqdq;->a:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lqdq;->b:Ljava/lang/Object;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lqdq;->c:J

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lqdq;->d:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lqdq;->e:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lqdq;->f:Ljava/util/Map;
...
.method public final a(J)Lpcd;
    ...
    iget-object v0, p0, Lqdq;->b:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lqdq;->f:Ljava/util/Map;
...
.method public final allocate(III)Lcom/google/googlex/gcam/base/LongPair;
    ...
    iget-object p2, p0, Lqdq;->a:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    iget-wide v1, p0, Lqdq;->c:J

    const-wide/16 v3, 0x1

    add-long/2addr v3, v1

    iput-wide v3, p0, Lqdq;->c:J

    iget-object p3, p0, Lqdq;->d:Ljava/util/Map;
    ...
    iget-object p3, p0, Lqdq;->e:Ljava/util/Map;
...
.method public final doneWriting(J)V
    ...
    iget-object v0, p0, Lqdq;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lqdq;->d:Ljava/util/Map;
    ...
    iget-object v1, p0, Lqdq;->e:Ljava/util/Map;
    ...
    iget-object v1, p0, Lqdq;->b:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iget-object v0, p0, Lqdq;->f:Ljava/util/Map;
