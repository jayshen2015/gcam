...
.method public final allocate(III)Lcom/google/googlex/gcam/base/LongPair;
    ...
    invoke-direct {v0, p1, p2}, Lqdf;-><init>(J)V

    iput-object v0, p0, Lqdw;->a:Lqdf;

    new-instance p1, Lcom/google/googlex/gcam/base/LongPair;

    iget-object p2, p0, Lqdw;->a:Lqdf;
...
.method public final doneWriting(J)V
    ...
    iget-boolean p1, p0, Lqdw;->b:Z

    xor-int/2addr p1, v3

    const/4 p2, 0x0

    sget-object p2, Landroid/support/v7/view/menu/rrH/EJjub;->UEzCP:Ljava/lang/String;

    invoke-static {p1, p2}, Lpao;->o(ZLjava/lang/Object;)V

    iput-boolean v3, p0, Lqdw;->b:Z
