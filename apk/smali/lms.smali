...
.method public constructor <init>(I)V
    ...
    invoke-direct {p1, p0, v0}, Llhx;-><init>(Ljava/lang/Object;I)V

    iput-object p1, p0, Llms;->e:Ljava/lang/Runnable;

    return-void
.end method

.method private final bw(ILmr;)I
    .locals 3
    ...
    :cond_0
    iget-object v0, p0, Llms;->a:Lcom/google/android/clockwork/common/wearable/wearmaterial/picker/CenteredRecyclerView;
    ...
    invoke-virtual {p0, v1}, Lme;->N(I)Landroid/view/View;
...
.method public final D(Lmr;)I
    ...
    :cond_1
    invoke-static {v0}, Llms;->br(Landroid/view/View;)I

    move-result v0

    invoke-static {p1}, Llms;->bu(Landroid/view/View;)I
...
.method protected final P(Lmr;[I)V
    .locals 3
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/LinearLayoutManager;->P(Lmr;[I)V
...
.method public final aK(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Llms;->a:Lcom/google/android/clockwork/common/wearable/wearmaterial/picker/CenteredRecyclerView;

    new-instance p1, Landroid/os/Handler;

    invoke-direct {p1}, Landroid/os/Handler;-><init>()V

    iput-object p1, p0, Llms;->d:Landroid/os/Handler;
...
.method public final c()V
    ...
    iget-object v10, v0, Lplm;->a:Ljava/lang/Object;

    if-nez v10, :cond_1

    const v10, 0x7f010059
    ...
    iput-object v3, v0, Lplm;->a:Ljava/lang/Object;

    :cond_1
    const/high16 v3, 0x3f800000    # 1.0f

    invoke-static {v9, v3}, Lbzb;->c(FF)F
    ...
    invoke-static {v8, v4}, Lbzb;->c(FF)F
...
.method public final d(ILmj;Lmr;)I
    ...
    invoke-direct {p0, p1, p3}, Llms;->bw(ILmr;)I
...
.method public final p(Lmr;)V
    ...
    iget-object p1, p0, Llms;->d:Landroid/os/Handler;

    if-eqz p1, :cond_0

    iget-object v0, p0, Llms;->e:Ljava/lang/Runnable;
