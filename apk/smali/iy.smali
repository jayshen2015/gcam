...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Liy;->c:Landroid/widget/ProgressBar;
...
.method final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lcbd;->a()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_8

    invoke-virtual {p0, v1, p2}, Liy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Liy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Liy;->a:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v0, p0, Liy;->a:Landroid/graphics/Bitmap;
...
.method public b(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Liy;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Liy;->b:[I
    ...
    invoke-virtual {p1, v2}, Landroidx/wear/ambient/AmbientDelegate;->w(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Liy;->c:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p0, v7, v0}, Liy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v0}, Landroidx/wear/ambient/AmbientDelegate;->w(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v2}, Liy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
