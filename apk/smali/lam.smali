...
.method private constructor <init>(ILandroid/view/animation/Interpolator;)V
    ...
    iput-object p2, p0, Llam;->b:Landroid/view/animation/Interpolator;

    new-instance p1, Landroid/animation/AnimatorSet;

    invoke-direct {p1}, Landroid/animation/AnimatorSet;-><init>()V

    iput-object p1, p0, Llam;->c:Landroid/animation/AnimatorSet;

    return-void
.end method

.method public static b(ILandroid/view/animation/Interpolator;)Llam;
    .locals 1

    new-instance v0, Llam;

    invoke-direct {v0, p0, p1}, Llam;-><init>(ILandroid/view/animation/Interpolator;)V
...
.method public final a()Landroid/animation/AnimatorSet;
    ...
    iget-object v0, p0, Llam;->c:Landroid/animation/AnimatorSet;
...
.method public final c(Ljava/lang/Object;Ljava/lang/String;FF)V
    ...
    iget-object p2, p0, Llam;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {p1, p2}, Landroid/animation/ObjectAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object p2, p0, Llam;->d:Landroid/animation/AnimatorSet$Builder;

    if-nez p2, :cond_0

    iget-object p2, p0, Llam;->c:Landroid/animation/AnimatorSet;

    invoke-virtual {p2, p1}, Landroid/animation/AnimatorSet;->play(Landroid/animation/Animator;)Landroid/animation/AnimatorSet$Builder;

    move-result-object p1

    iput-object p1, p0, Llam;->d:Landroid/animation/AnimatorSet$Builder;
