...
.method public final onError(Landroid/media/MediaCodec;Landroid/media/MediaCodec$CodecException;)V
    ...
    iget-object p1, p1, Lnqh;->e:Lqbg;

    invoke-virtual {p1, p2}, Lqbg;->a(Ljava/lang/Throwable;)Z

    iget-object p1, p0, Lnqg;->a:Lnqh;

    invoke-virtual {p1}, Lnqh;->e()V
    ...
    sget-object v0, Landroidx/preference/internal/ZEHR/IRiqsOtIwWoeJC;->wMDGqnLfTb:Ljava/lang/String;
    ...
    iget-object p1, p1, Lnqh;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, p1, Lnqh;->o:Lnqr;

    invoke-interface {p1, p2}, Lnqr;->d(I)V

    iget-object p1, p0, Lnqg;->a:Lnqh;

    iget-object p1, p1, Lnqh;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final onInputBufferAvailable(Landroid/media/MediaCodec;I)V
    ...
    iget-object v0, v0, Lnqh;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0, p2}, Lnqh;->g(I)V
    ...
    iget-object v0, v0, Lnqh;->d:Ljava/util/Deque;
    ...
    iget-object p2, p0, Lnqg;->a:Lnqh;

    iget-object p2, p2, Lnqh;->o:Lnqr;

    iget-object v0, p0, Lnqg;->a:Lnqh;

    invoke-interface {p2, v0}, Lnqr;->e(Lnqh;)V
...
.method public final onOutputBufferAvailable(Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object v1, v1, Lnqh;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-interface {v1, p3}, Lnqr;->b(Landroid/media/MediaCodec$BufferInfo;)V
    :try_end_0
    ...
    iget-object v1, v1, Lnqh;->n:Lnra;

    iget-object v9, p0, Lnqg;->a:Lnqh;

    iget-boolean v2, v9, Lnqh;->m:Z
    ...
    invoke-direct/range {v2 .. v8}, Lnqf;-><init>(Lnqh;Landroid/media/MediaCodec;Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;Landroid/media/MediaCodec$LinearBlock;I)V
    ...
    :try_start_2
    iget-object p2, v9, Lnqh;->l:Ljava/util/Set;
    ...
    :try_start_3
    invoke-interface {v1, v10}, Lnra;->a(Lnqf;)V
    :try_end_3
    ...
    iget-object p3, p0, Lnqg;->a:Lnqh;

    iget-object p3, p3, Lnqh;->j:Lnqg;

    invoke-virtual {p3, p1, p2}, Lnqg;->onError(Landroid/media/MediaCodec;Landroid/media/MediaCodec$CodecException;)V
    ...
    invoke-virtual {p1, p3}, Lnqh;->c(Landroid/media/MediaCodec$BufferInfo;)V
...
.method public final onOutputFormatChanged(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)V
    ...
    iget-object p1, p1, Lnqh;->n:Lnra;

    invoke-interface {p1, p2}, Lnra;->b(Landroid/media/MediaFormat;)V
