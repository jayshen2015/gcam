...
# virtual methods
.method public final a(IJLjava/util/concurrent/atomic/AtomicLong;Lqat;)V
    .locals 10

    invoke-static {p1}, Lnie;->aU(I)Ljava/lang/String;
    ...
    invoke-static {p2, p3, p4}, Lmnu;->c(JLjava/util/concurrent/atomic/AtomicLong;)Z
    ...
    invoke-interface {p5, v1, v2, v0}, Lqat;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_2
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_0 .. :try_end_0} :catch_0
