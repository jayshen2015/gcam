...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lody;->a:Ljava/util/logging/Logger;

    return-void
.end method

.method public static a(Ljava/io/InputStream;)Ldev;
    .locals 12
    ...
    iput-object v4, v2, Lplm;->a:Ljava/lang/Object;
    ...
    :cond_a
    :try_start_6
    sget-object v2, Lody;->a:Ljava/util/logging/Logger;
    ...
    :try_start_8
    sget-object v3, Lody;->a:Ljava/util/logging/Logger;
    ...
    iget-object v5, v2, Lplm;->a:Ljava/lang/Object;

    check-cast v5, [B

    const-string v6, "http://ns.adobe.com/xap/1.0/\u0000"

    invoke-static {v5, v6}, Lody;->b([BLjava/lang/String;)Z

    move-result v5

    if-eqz v5, :cond_b

    iget-object p0, v2, Lplm;->a:Ljava/lang/Object;
    ...
    iget-object v1, v2, Lplm;->a:Ljava/lang/Object;
    ...
    move-result-object p0
    :try_end_a
    .catch Ldeu; {:try_start_a .. :try_end_a} :catch_3
    ...
    sget-object v5, Lody;->a:Ljava/util/logging/Logger;
    ...
    invoke-interface {p0, v1, v2}, Ldev;->e(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_b
    invoke-interface {p0, v1, v2}, Ldev;->a(Ljava/lang/String;Ljava/lang/String;)Ldfy;

    move-result-object v1

    check-cast v1, Ldfi;

    iget-object v1, v1, Ldfi;->a:Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v5}, La;->ax(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v9, v1}, Lody;->b([BLjava/lang/String;)Z
    ...
    iget-object v10, v8, Lplm;->a:Ljava/lang/Object;
    ...
    :try_end_c
    .catch Ldeu; {:try_start_c .. :try_end_c} :catch_5
    ...
    sget-object v8, Lcom/google/googlex/gcam/lasagna/aSG/BoNwn;->hxUrTdMKVEJ:Ljava/lang/String;

    const-string v9, "Extended XMP parse error"

    invoke-virtual/range {v5 .. v10}, Ljava/util/logging/Logger;->logp(Ljava/util/logging/Level;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_d
    .catch Ldeu; {:try_start_d .. :try_end_d} :catch_7

    :goto_8
    if-eqz v4, :cond_13

    :try_start_e
    invoke-interface {v4}, Ldev;->f()Ldfh;

    move-result-object v0

    :cond_12
    :goto_9
    invoke-virtual {v0}, Ldfh;->next()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Ldfe;

    iget-object v2, v1, Ldfe;->b:Ljava/lang/String;

    if-eqz v2, :cond_12

    iget-object v3, v1, Ldfe;->a:Ljava/lang/String;

    iget-object v4, v1, Ldfe;->c:Ljava/lang/Object;

    invoke-virtual {v1}, Ldfe;->a()Ldfw;

    move-result-object v1

    invoke-interface {p0, v3, v2, v4, v1}, Ldev;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ldfw;)V
    :try_end_e
