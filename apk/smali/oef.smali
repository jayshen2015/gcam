...
.method public constructor <init>(Lntj;)V
    ...
    iput-object v0, p0, Loef;->c:Ljava/lang/Object;

    new-instance v0, Loei;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Loei;-><init>([B)V

    iput-object v0, p0, Loef;->b:Lofa;

    iget-object p1, p1, Lntj;->a:Ljava/lang/Object;

    check-cast p1, Landroid/content/Context;

    iput-object p1, p0, Loef;->a:Landroid/content/Context;

    return-void
.end method

.method public static g(Landroid/content/Context;)Lntj;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Lntj;-><init>(Landroid/content/Context;[B)V
...
.method private final h(Landroid/net/Uri;)Z
    ...
    iget-object v0, p0, Loef;->a:Landroid/content/Context;
...
.method private static final i()V
    ...
    invoke-direct {v0, v1}, Loel;-><init>(Ljava/lang/String;)V
...
.method protected final a(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-direct {p0, p1}, Loef;->h(Landroid/net/Uri;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lofb;->c(Landroid/net/Uri;)Ljava/io/File;
    ...
    invoke-static {p1}, Loet;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-direct {p1, v0}, Loem;-><init>(Ljava/lang/String;)V

    throw p1
.end method

.method protected final b()Lofa;
    .locals 1

    iget-object v0, p0, Loef;->b:Lofa;
...
.method public final c(Landroid/net/Uri;)Ljava/io/File;
    ...
    invoke-direct {v0, p1}, Loem;-><init>(Ljava/lang/String;)V
    ...
    :pswitch_1
    invoke-static {v0}, Lntt;->i(Landroid/content/Context;)Ljava/io/File;
    ...
    sget-object v0, Loee;->a:Landroid/accounts/Account;
    ...
    sget-object p1, Loee;->a:Landroid/accounts/Account;
    ...
    invoke-static {v5, v6, v7}, Lnvw;->p(ZLjava/lang/String;[Ljava/lang/Object;)V
    ...
    :goto_3
    invoke-static {p1}, Loee;->a(Landroid/accounts/Account;)Z
    ...
    invoke-direct {v0, p1}, Loem;-><init>(Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Loef;->a:Landroid/content/Context;

    invoke-static {p1}, Lnik;->d(Landroid/content/Context;)Z
    ...
    :cond_5
    iget-object v1, p0, Loef;->c:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iget-object p1, p0, Loef;->d:Ljava/lang/String;
    ...
    invoke-static {p1}, Lntt;->i(Landroid/content/Context;)Ljava/io/File;
    ...
    iput-object p1, p0, Loef;->d:Ljava/lang/String;
    ...
    invoke-direct {p1, v0}, Loel;-><init>(Ljava/lang/String;)V
...
.method public final d(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    invoke-interface {v0, p1}, Lofa;->d(Landroid/net/Uri;)Ljava/io/InputStream;
