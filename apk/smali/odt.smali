...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lodt;->a:[Ljava/lang/String;
    ...
    sput-object v0, Lodt;->b:[Ljava/lang/String;
    ...
    sput-object v0, Lodt;->c:[Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    ...
    invoke-static {p0, p1, p2, v0}, Lodt;->b(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Lods;)Landroid/content/res/AssetFileDescriptor;
...
.method public static b(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Lods;)Landroid/content/res/AssetFileDescriptor;
    .locals 17
    ...
    invoke-direct {v13, v1, v12}, Loar;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    sget-object v14, Lods;->a:Lods;

    iget-object v14, v3, Lods;->d:Lphh;

    move-object v15, v14

    check-cast v15, Lpkg;

    iget v15, v15, Lpkg;->c:I
    ...
    iget-boolean v6, v3, Lods;->b:Z

    invoke-virtual {v8, v0, v13, v6}, Lodu;->a(Landroid/content/Context;Loar;Z)I
    ...
    sget-object v0, Lodt;->b:[Ljava/lang/String;
    ...
    :cond_6
    sget-object v0, Lodt;->c:[Ljava/lang/String;
    ...
    :cond_7
    sget-object v0, Lodt;->a:[Ljava/lang/String;
    ...
    invoke-static {v0}, Lodt;->f(Ljava/lang/Object;)V
    ...
    invoke-static {v2}, Lodt;->f(Ljava/lang/Object;)V
    ...
    invoke-direct {v5, v4, v6}, Lmnq;-><init>(Ljava/lang/Object;I)V

    invoke-static {v5}, Loce;->c(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    invoke-direct {v4, v1, v9}, Lmnq;-><init>(Ljava/lang/Object;I)V

    invoke-static {v4}, Loce;->c(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    sget-object v4, Lcom/google/android/apps/common/proguard/KwQ/eyZfTGNrYT;->AGUSthNo:Ljava/lang/String;
    ...
    iget-boolean v4, v3, Lods;->c:Z

    if-nez v4, :cond_13

    invoke-static/range {p0 .. p0}, Lbzs;->b(Landroid/content/Context;)Ljava/io/File;

    move-result-object v4

    if-eqz v4, :cond_c

    invoke-static {v4}, Lodt;->c(Ljava/io/File;)Ljava/lang/String;
    ...
    :cond_d
    invoke-static/range {p0 .. p0}, Lbzs;->a(Landroid/content/Context;)Landroid/content/Context;

    move-result-object v4

    if-eqz v4, :cond_e

    invoke-static {v4}, Lbzs;->b(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-direct {v4, v0, v5}, Lmnq;-><init>(Ljava/lang/Object;I)V

    invoke-static {v4}, Lodt;->e(Ljava/util/concurrent/Callable;)[Ljava/io/File;
    ...
    invoke-static {v7}, Lodt;->c(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lodt;->c(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v2, v1}, Lodt;->d(Landroid/content/res/AssetFileDescriptor;Ljava/io/FileNotFoundException;)V
    ...
    invoke-static {v2, v0}, Lodt;->d(Landroid/content/res/AssetFileDescriptor;Ljava/io/FileNotFoundException;)V
...
.method private static f(Ljava/lang/Object;)V
    ...
    sget-object v0, Landroidx/compose/ui/draw/mFA/hLxBhVsNtRdO;->lSjETyLbSCpdoO:Ljava/lang/String;
