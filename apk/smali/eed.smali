...
.method static constructor <clinit>()V
    ...
    sput-object v0, Leed;->b:Landroid/net/Uri;
    ...
    sput-object v0, Leed;->c:Landroid/net/Uri;
    ...
    sput-object v0, Leed;->d:Landroid/net/Uri;
...
.method public static final a(Ljava/lang/String;Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, Llsk;-><init>(Landroid/content/Context;)V

    new-instance v1, Llya;

    invoke-direct {v1}, Llya;-><init>()V
    ...
    iput-object p0, v1, Llya;->b:Ljava/lang/String;
    ...
    iput-object p0, v1, Llya;->a:Ljava/lang/String;

    invoke-virtual {v1}, Llya;->a()Llyb;

    move-result-object p0

    iget-object p1, v0, Llsk;->g:Llsn;
    ...
    invoke-direct {v0, p1, p0}, Llxw;-><init>(Llsn;Llyb;)V

    invoke-virtual {p1, v0}, Llsn;->a(Lltf;)V

    invoke-static {v0}, Lnie;->cT(Llsq;)Lmdr;
...
.method public static final b(Landroid/content/Context;Landroid/app/Activity;)V
    ...
    invoke-static {v0, p0}, Leed;->d(Ljava/lang/String;Landroid/content/Context;)Landroid/content/Intent;

    move-result-object p0

    new-instance v0, Lknd;

    invoke-direct {v0, p1}, Lknd;-><init>(Landroid/app/Activity;)V

    invoke-virtual {v0, p0}, Lknd;->m(Landroid/content/Intent;)V
...
.method private static final d(Ljava/lang/String;Landroid/content/Context;)Landroid/content/Intent;
    ...
    sget-object v0, Leed;->b:Landroid/net/Uri;
    ...
    sget-object v3, Leed;->c:Landroid/net/Uri;
    ...
    sget-object v3, Leed;->d:Landroid/net/Uri;
