...
# direct methods
.method public constructor <init>(Lmqa;Lfpd;)V
    .locals 2
    ...
    iput-object p1, p0, Limu;->a:Lmqb;

    iput-object p2, p0, Limu;->c:Lfpd;
...
# virtual methods
.method public final a(Lndu;DD)V
    .locals 6

    sget-object p4, Landroid/hardware/camera2/CaptureResult;->SENSOR_TIMESTAMP:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {p1, p4}, Lndu;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p5}, Lndu;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-virtual {p5, v0, v1, v2, v3}, Lfpd;->b(JJ)V

    :cond_0
    iget-wide p4, p0, Limu;->b:D
    ...
    sget-object v5, Lcom/google/googlex/gcam/lasagna/aSG/BoNwn;->qnYoUUTOZAW:Ljava/lang/String;
    ...
    invoke-interface {p1, p4}, Lmqb;->f(Ljava/lang/String;)V
