...
.method public constructor <init>(JJ)V
    ...
    invoke-static {v4, v0}, Lpao;->d(ZLjava/lang/Object;)V

    const-string v0, "lockUsage must contain USAGE_CPU_WRITE_RARELY."

    invoke-static {v4, v0}, Lpao;->d(ZLjava/lang/Object;)V

    iput-wide p1, p0, Lqdt;->a:J

    iput-wide p3, p0, Lqdt;->b:J
...
.method public final a()Landroid/hardware/HardwareBuffer;
    ...
    iget-object v0, p0, Lqdt;->c:Landroid/hardware/HardwareBuffer;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lqdt;->d:Lcom/google/googlex/gcam/LockedHardwareBuffer;
...
.method public final allocate(III)Lcom/google/googlex/gcam/base/LongPair;
    ...
    iget-object p3, p0, Lqdt;->c:Landroid/hardware/HardwareBuffer;
    ...
    iput-object p1, p0, Lqdt;->c:Landroid/hardware/HardwareBuffer;

    iget-wide p2, p0, Lqdt;->b:J
    ...
    iput-object p1, p0, Lqdt;->d:Lcom/google/googlex/gcam/LockedHardwareBuffer;

    new-instance p1, Lcom/google/googlex/gcam/base/LongPair;

    iget-object p2, p0, Lqdt;->d:Lcom/google/googlex/gcam/LockedHardwareBuffer;
...
.method public final doneWriting(J)V
    ...
    iget-object p1, p0, Lqdt;->c:Landroid/hardware/HardwareBuffer;
    ...
    iget-object p1, p0, Lqdt;->d:Lcom/google/googlex/gcam/LockedHardwareBuffer;
