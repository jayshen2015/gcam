...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    :pswitch_0
    invoke-virtual {v0}, Lhvm;->E()V

    return-void

    :pswitch_1
    iget-object p1, v0, Lhvm;->m:Lcom/google/android/apps/camera/legacy/lightcycle/storage/LocalSessionStorage;

    iget-object v1, p1, Lcom/google/android/apps/camera/legacy/lightcycle/storage/LocalSessionStorage;->b:Ljlj;

    iget-object v1, v1, Ljlj;->e:Lnmf;

    invoke-virtual {v1}, Lnmf;->j()Z
    ...
    :cond_1
    invoke-virtual {v1}, Lnmf;->i()Ljava/io/File;
    ...
    iget-object v2, v0, Lhvm;->M:Ljea;

    iget-wide v2, v2, Ljea;->b:J

    const-wide/32 v4, 0xf4240

    div-long/2addr v2, v4

    iget-boolean v4, v0, Lhvm;->B:Z
    ...
    sput-object v1, Lhem;->b:Ljava/lang/Boolean;
    ...
    invoke-direct {v1, v0, p1}, Lhvg;-><init>(Lhvm;Lcom/google/android/apps/camera/legacy/lightcycle/storage/LocalSessionStorage;)V

    new-instance v2, Lhfr;

    invoke-direct {v2, p1, v1}, Lhfr;-><init>(Lcom/google/android/apps/camera/legacy/lightcycle/storage/LocalSessionStorage;Lhvg;)V

    invoke-virtual {v2}, Lhfr;->start()V
