...
.method protected constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p1, p2, p0, v0}, Lej;-><init>(Landroid/content/Context;Lfl;Landroid/view/Window;)V
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-super/range {p0 .. p1}, Lfl;->onCreate(Landroid/os/Bundle;)V

    move-object/from16 v0, p0

    iget-object v1, v0, Lel;->a:Lej;
    ...
    :goto_0
    iget-object v3, v1, Lej;->b:Lfl;

    invoke-virtual {v3, v2}, Loz;->setContentView(I)V

    iget-object v2, v1, Lej;->c:Landroid/view/Window;
    ...
    iget-object v9, v1, Lej;->g:Landroid/view/View;
    ...
    iget-object v9, v1, Lej;->a:Landroid/content/Context;
    ...
    invoke-static {v9}, Lej;->b(Landroid/view/View;)Z
    ...
    :cond_4
    iget-object v12, v1, Lej;->c:Landroid/view/Window;
    ...
    :cond_5
    iget-object v10, v1, Lej;->c:Landroid/view/Window;
    ...
    iget-boolean v9, v1, Lej;->i:Z

    iget-object v9, v1, Lej;->f:Landroid/widget/ListView;
    ...
    invoke-static {v3, v4}, Lej;->d(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v3

    invoke-static {v5, v6}, Lej;->d(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v4

    invoke-static {v7, v8}, Lej;->d(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v5

    iget-object v6, v1, Lej;->c:Landroid/view/Window;
    ...
    iput-object v6, v1, Lej;->r:Landroidx/core/widget/NestedScrollView;

    iget-object v6, v1, Lej;->r:Landroidx/core/widget/NestedScrollView;
    ...
    iput-object v6, v1, Lej;->w:Landroid/widget/TextView;

    iget-object v6, v1, Lej;->w:Landroid/widget/TextView;
    ...
    :cond_8
    iget-object v7, v1, Lej;->e:Ljava/lang/CharSequence;
    ...
    iget-object v7, v1, Lej;->w:Landroid/widget/TextView;

    invoke-virtual {v6, v7}, Landroidx/core/widget/NestedScrollView;->removeView(Landroid/view/View;)V

    iget-object v6, v1, Lej;->f:Landroid/widget/ListView;
    ...
    iget-object v7, v1, Lej;->r:Landroidx/core/widget/NestedScrollView;
    ...
    iget-object v8, v1, Lej;->f:Landroid/widget/ListView;
    ...
    iput-object v6, v1, Lej;->j:Landroid/widget/Button;

    iget-object v6, v1, Lej;->j:Landroid/widget/Button;

    iget-object v7, v1, Lej;->I:Landroid/view/View$OnClickListener;

    invoke-virtual {v6, v7}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v6, v1, Lej;->k:Ljava/lang/CharSequence;
    ...
    iget-object v7, v1, Lej;->k:Ljava/lang/CharSequence;
    ...
    iput-object v7, v1, Lej;->m:Landroid/widget/Button;

    iget-object v7, v1, Lej;->m:Landroid/widget/Button;

    iget-object v8, v1, Lej;->I:Landroid/view/View$OnClickListener;

    invoke-virtual {v7, v8}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v7, v1, Lej;->n:Ljava/lang/CharSequence;
    ...
    iget-object v8, v1, Lej;->n:Ljava/lang/CharSequence;
    ...
    iput-object v7, v1, Lej;->p:Landroid/widget/Button;

    iget-object v7, v1, Lej;->p:Landroid/widget/Button;

    iget-object v8, v1, Lej;->I:Landroid/view/View$OnClickListener;

    invoke-virtual {v7, v8}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v7, v1, Lej;->q:Ljava/lang/CharSequence;
    ...
    iget-object v8, v1, Lej;->p:Landroid/widget/Button;
    ...
    iget-object v9, v1, Lej;->q:Ljava/lang/CharSequence;
    ...
    :goto_7
    iget-object v8, v1, Lej;->a:Landroid/content/Context;
    ...
    invoke-static {v6}, Lej;->c(Landroid/widget/Button;)V
    ...
    iget-object v6, v1, Lej;->m:Landroid/widget/Button;
    ...
    iget-object v6, v1, Lej;->p:Landroid/widget/Button;
    ...
    :cond_11
    :goto_8
    iget-object v6, v1, Lej;->x:Landroid/view/View;
    ...
    iget-object v10, v1, Lej;->x:Landroid/view/View;
    ...
    iput-object v6, v1, Lej;->u:Landroid/widget/ImageView;

    iget-object v6, v1, Lej;->d:Ljava/lang/CharSequence;
    ...
    iput-object v6, v1, Lej;->v:Landroid/widget/TextView;

    iget-object v6, v1, Lej;->v:Landroid/widget/TextView;

    iget-object v8, v1, Lej;->d:Ljava/lang/CharSequence;

    invoke-virtual {v6, v8}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget v6, v1, Lej;->s:I

    iget-object v6, v1, Lej;->t:Landroid/graphics/drawable/Drawable;

    if-eqz v6, :cond_13

    iget-object v8, v1, Lej;->u:Landroid/widget/ImageView;
    ...
    iget-object v10, v1, Lej;->u:Landroid/widget/ImageView;

    invoke-virtual {v10}, Landroid/widget/ImageView;->getPaddingTop()I

    move-result v10

    iget-object v12, v1, Lej;->u:Landroid/widget/ImageView;

    invoke-virtual {v12}, Landroid/widget/ImageView;->getPaddingRight()I

    move-result v12

    iget-object v13, v1, Lej;->u:Landroid/widget/ImageView;
    ...
    iget-object v6, v1, Lej;->u:Landroid/widget/ImageView;
    ...
    :cond_19
    iget-object v6, v1, Lej;->e:Ljava/lang/CharSequence;
    ...
    :cond_1d
    :goto_f
    iget-object v3, v1, Lej;->f:Landroid/widget/ListView;
    ...
    iget-object v2, v1, Lej;->f:Landroid/widget/ListView;

    if-nez v2, :cond_22

    iget-object v2, v1, Lej;->r:Landroidx/core/widget/NestedScrollView;
    ...
    iget-object v5, v1, Lej;->c:Landroid/view/Window;
    ...
    invoke-static {v2, v3, v7}, Lcdp;->d(Landroid/view/View;II)V
    ...
    iget-object v3, v1, Lej;->y:Landroid/widget/ListAdapter;
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget-object v0, v0, Lej;->r:Landroidx/core/widget/NestedScrollView;
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Lfl;->onKeyDown(ILandroid/view/KeyEvent;)Z
...
.method public final onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Lfl;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-super {p0, p1}, Lfl;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lel;->a:Lej;

    invoke-virtual {v0, p1}, Lej;->a(Ljava/lang/CharSequence;)V
