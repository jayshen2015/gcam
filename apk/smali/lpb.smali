...
# direct methods
.method public constructor <init>(Llpc;Landroid/content/Context;)V
    .locals 2
...
.method private final a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :goto_0
    :try_start_2
    iget-object v2, p0, Llpb;->a:Llpc;

    const-string v3, "Error querying for table"

    invoke-virtual {v2, v3, p2, p1}, Llot;->v(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method public final getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v0, v0, Llpc;->e:Llqb;

    const-wide/32 v1, 0x36ee80

    invoke-virtual {v0, v1, v2}, Llqb;->c(J)Z
    ...
    invoke-virtual {v0, v1}, Llot;->n(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Llpb;->a:Llpc;

    iget-object v1, v1, Llpc;->e:Llqb;

    invoke-virtual {v1}, Llqb;->a()V
    :try_end_1
...
.method public final onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    sget-object v0, Llpt;->a:Llpt;

    const-string v1, "Invalid version number"

    if-eqz v0, :cond_1

    invoke-virtual {v0, v1, p1}, Llot;->o(Ljava/lang/String;Ljava/lang/Object;)V

    goto :goto_1

    :cond_1
    sget-object v0, Llps;->a:Lrrw;
    ...
    :cond_2
    :goto_0
    sget-object p1, Llpo;->b:Lkvy;

    invoke-virtual {p1}, Lkvy;->j()Ljava/lang/Object;
...
.method public final onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1, v0}, Llpb;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    sget-object v0, Llpc;->a:Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1, v0}, Llpb;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    sget-object v7, Landroidx/compose/ui/draw/mFA/hLxBhVsNtRdO;->IOMJFL:Ljava/lang/String;
    ...
    sget-object v7, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/aD/cAJKfDoLjpqWV;->aSPsbwdck:Ljava/lang/String;
    ...
    sget-object v3, Landroid/support/v7/view/menu/rrH/EJjub;->BKvqRDm:Ljava/lang/String;
