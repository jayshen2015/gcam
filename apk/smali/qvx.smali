...
.method public static a(Lqpo;Ljava/lang/String;IZLandroid/content/Context;)Lqpp;
    .locals 6
    ...
    invoke-static {p1, p4}, Lqvx;->b(Ljava/lang/String;Landroid/content/Context;)Ljava/io/File;
    ...
    :try_start_3
    sget-object p2, Lqvx;->a:Ljava/lang/String;
    ...
    :cond_5
    :try_start_7
    invoke-interface {p0, p2}, Lqpo;->d([B)Lqpo;

    move-result-object p0

    invoke-interface {p0}, Lqpo;->l()Lqpp;

    move-result-object p0
    :try_end_7
    .catch Lqou; {:try_start_7 .. :try_end_7} :catch_5
...
.method public static b(Ljava/lang/String;Landroid/content/Context;)Ljava/io/File;
    ...
    sget-object v1, Landroidx/compose/ui/draw/mFA/hLxBhVsNtRdO;->AwLe:Ljava/lang/String;
