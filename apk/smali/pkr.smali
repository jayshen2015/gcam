...
.method public constructor <init>(Llvp;Llvq;)V
    ...
    invoke-static {p1}, LAGC;->setShotMaxISO(Llvp;)V
...
.method public static d(Llvp;Llvq;Llzv;)I
    ...
    .param p1, "totalCaptureResultProxy"    # Llvq;
    ...
    invoke-static {p0, p1, p2}, LAGC;->getGcamSensorId(Llvp;Llvq;Llzv;)I
...
.method public static e(Llvp;)J
    ...
    :cond_0
    invoke-static {p0}, LAGC;->getReadoutTimeNs(Llvp;)J
...
.method public static h(Llvp;)Llwp;
    ...
    invoke-static {p0}, LMetadataConverterUtil;->getGcamRawFormat(Llvp;)Llwp;
...
.method public static s(Llvp;Llzv;)[F
    ...
    invoke-static {p0, p1}, LMetadataConverterUtil;->getAnalogAndDigitalGain(Llvp;Llzv;)[F
...
.method public static v(Llvp;)Lcom/google/googlex/gcam/StaticMetadata;
    ...
    invoke-static {v1}, LMetadataConverterUtil;->convertToGcamStaticMetadata(Llvp;)Lcom/google/googlex/gcam/StaticMetadata;
    ...
    invoke-static {v0}, LAGC;->getExpastro(F)F
...
.method public static y(Llvp;Llvq;Llzv;)Llvp;
    ...
    invoke-static {p0, p1, p2}, LMetadataConverterUtil;->getPhysicalCharacteristics(Llvp;Llvq;Llzv;)Llvp;
...
.method public final j(Llzv;)Lcom/google/googlex/gcam/AwbInfo;
    ...
    invoke-static {p0, p1}, LMetadataConverterUtil;->getAwbInfoCaptured(Lpkr;Llzv;)Lcom/google/googlex/gcam/AwbInfo;
...
.method public final m(Llzv;Lcom/google/googlex/gcam/GyroSampleVector;Ljava/util/Map;)Lcom/google/googlex/gcam/FrameMetadata;
    ...
    invoke-static {v15, v11, v2}, LAGC;->setExposureTimeMs(Lcom/google/googlex/gcam/FrameMetadata;Llvp;Llzv;)V
    ...
    invoke-static {v2}, LAGC;->setSensorISO(Llzv;)V
    ...
    invoke-static {v4, v7}, Lcom/agc/NoiseModels;->NR_Scale(FI)F
    ...
    invoke-static {v4, v7}, Lcom/agc/NoiseModels;->NR_Offset(FI)F
    ...
    invoke-static {v2, v11, v5}, LAGC;->getBlackLevel(Llzv;Llvp;Lcom/google/googlex/gcam/FrameMetadata;)V
...
.method public final p(Llzv;)Lcom/google/googlex/gcam/SpatialGainMap;
    .locals 18
    .param p1, "totalCaptureResultProxy"    # Llzv;
...
.method public final u(Lcom/google/googlex/gcam/FrameRequest;Llzv;Lgzs;)V
    ...
    invoke-static {v4}, LAGC;->getExposureTimeMs(F)F

    move-result v4

    invoke-static {}, Lcom/custom/slider;->getDesiredExposureTimeMs()Ljava/lang/Long;
    ...
    sput v5, Lcom/custom/slider;->sGainAE:F

    invoke-static {}, Lcom/custom/slider;->setManualIsoSlider()V

    sget v5, Lcom/custom/slider;->sManualIsoGain:F
    ...
    sput v4, LAGC;->sGetDesired_exposure_time_ms:F

    sput v5, LAGC;->sGetDesired_analog_gain:F

    sput v6, LAGC;->sGetDesired_digital_gain:F

    invoke-static {}, LAGC;->MinISOParamDesired()V

    sget v4, LAGC;->sGetDesired_exposure_time_ms:F

    sget v5, LAGC;->sGetDesired_analog_gain:F

    sget v6, LAGC;->sGetDesired_digital_gain:F
