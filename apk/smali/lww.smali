...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llww;->b:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Llww;->a:Lj$/util/concurrent/ConcurrentHashMap;

    return-void
.end method

.method public static a()Llww;
    .locals 2
    ...
    sget-object v0, Llww;->b:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Llww;->c:Llww;
...
.method public final b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2}, Llww;->e(Landroid/content/ServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Llww;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v0}, Llww;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p1, p0, Llww;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    :cond_0
    invoke-static {p1, p2}, Llww;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final c(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-virtual {v3, v0, v2}, Lltz;->K(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Llww;->e(Landroid/content/ServiceConnection;)Z
    ...
    iget-object p2, p0, Llww;->a:Lj$/util/concurrent/ConcurrentHashMap;
