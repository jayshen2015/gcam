...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfnz;->a:Ljava/lang/String;
    ...
    sput-object v0, Lfnz;->b:Ljava/lang/String;
    ...
    sput-object v0, Lfnz;->c:[Ljava/lang/String;

    new-array v0, v5, [Ljava/lang/String;

    aput-object v9, v0, v3

    sput-object v0, Lfnz;->d:[Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/ContentResolver;Lney;Lfll;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lfnz;->f:Landroid/content/ContentResolver;
    ...
    iget-object p2, p2, Lney;->o:Ljava/lang/String;
    ...
    iput-object p1, p0, Lfnz;->g:Ljava/lang/String;

    iput-object p3, p0, Lfnz;->h:Lfll;
...
# virtual methods
.method public final b(Landroid/database/Cursor;)Lfnx;
    .locals 19
    ...
    invoke-static {v6}, Lnie;->H(Ljava/lang/String;)Z

    move-result v0

    invoke-static {v3, v4, v0}, Lfnz;->a(JZ)Landroid/net/Uri;
    ...
    :cond_1
    :goto_0
    iget-object v13, v1, Lfnz;->h:Lfll;

    sget-object v17, Lflr;->a:Ljava/lang/Float;

    invoke-interface {v13}, Lfll;->d()V
    ...
    :cond_2
    iget-object v0, v1, Lfnz;->f:Landroid/content/ContentResolver;
    ...
    invoke-static {v15, v0}, Lmpr;->g(II)Lmpr;
    ...
    :try_start_4
    invoke-static {v15, v13}, La;->B(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v15, v1, v13, v0}, Loe;->f(Ljava/lang/String;CLply;Ljava/lang/Throwable;)V

    const/4 v1, 0x0

    invoke-static {v1, v1}, Lmpr;->g(II)Lmpr;

    move-result-object v0

    :goto_2
    iget v15, v0, Lmpr;->b:I

    iget v0, v0, Lmpr;->a:I

    :goto_3
    invoke-static {v0, v15}, Lmpr;->g(II)Lmpr;
    ...
    invoke-static {v13, v2, v14}, Lnvw;->I(ZLjava/lang/String;Ljava/lang/Object;)V

    invoke-static {v5}, Lpcf;->b(Ljava/lang/String;)Z
    ...
    invoke-static {v2, v13, v14}, Lnvw;->I(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v2, v9, v14}, Lnvw;->I(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v15, v0, v1, v14}, Lnvw;->K(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-static {}, Lfny;->k()Lfnx;

    move-result-object v0

    invoke-virtual {v0, v3, v4}, Lfnx;->b(J)V

    invoke-virtual {v0, v5}, Lfnx;->h(Ljava/lang/String;)V

    invoke-virtual {v0, v6}, Lfnx;->f(Ljava/lang/String;)V

    invoke-virtual {v0, v11}, Lfnx;->c(Lj$/time/Instant;)V

    invoke-virtual {v0, v12}, Lfnx;->e(Lj$/time/Instant;)V

    invoke-virtual {v0, v14}, Lfnx;->i(Landroid/net/Uri;)V
    ...
    :goto_7
    invoke-virtual {v0, v13}, Lfnx;->d(Z)V
    ...
    invoke-static {v2, v1}, Lnvw;->P(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method final c(Landroid/net/Uri;Ljmd;)Lfny;
    .locals 8

    sget-object v0, Lfnz;->c:[Ljava/lang/String;

    iget-object v1, p0, Lfnz;->f:Landroid/content/ContentResolver;
    ...
    invoke-virtual {p0, v0}, Lfnz;->b(Landroid/database/Cursor;)Lfnx;

    move-result-object p1

    iput-object p2, p1, Lfnx;->a:Ljmd;

    invoke-virtual {p1}, Lfnx;->a()Lfny;
    ...
    invoke-static {v7, v4}, Lnvw;->P(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method public final d(Landroid/net/Uri;[Ljava/lang/String;JJILjava/util/function/Function;)Ljava/util/List;
    ...
    sget-object v2, Lfnz;->d:[Ljava/lang/String;
    ...
    sget-object v2, Lfnz;->c:[Ljava/lang/String;
    ...
    invoke-static {v2, v5}, Lpao;->d(ZLjava/lang/Object;)V

    iget-object v2, v1, Lfnz;->g:Ljava/lang/String;
    ...
    iget-object v2, v1, Lfnz;->f:Landroid/content/ContentResolver;

    sget-object v5, Lfnz;->b:Ljava/lang/String;

    sget-object v7, Lfnz;->a:Ljava/lang/String;
...
.method public final e(Lj$/time/Instant;Lj$/time/Instant;Z)Ljava/util/List;
    ...
    sget-object v3, Lfnz;->d:[Ljava/lang/String;
    ...
    new-instance v9, Lkul;

    const/4 p1, 0x1

    invoke-direct {v9, p3, p1}, Lkul;-><init>(ZI)V

    move-object v1, p0

    invoke-virtual/range {v1 .. v9}, Lfnz;->d(Landroid/net/Uri;[Ljava/lang/String;JJILjava/util/function/Function;)Ljava/util/List;
