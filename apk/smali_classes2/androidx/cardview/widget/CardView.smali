...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0}, Lwn;-><init>(Landroidx/cardview/widget/CardView;)V

    iput-object v1, p0, Landroidx/cardview/widget/CardView;->f:Lwn;

    sget-object v2, Lwm;->a:[I
    ...
    sget-object v6, Lwm;->a:[I

    const v10, 0x7f1501b1
    ...
    invoke-direct {v0, p1, p3}, Lwo;-><init>(Landroid/content/res/ColorStateList;F)V

    iput-object v0, v1, Lwn;->a:Landroid/graphics/drawable/Drawable;

    iget-object p1, v1, Lwn;->b:Landroidx/cardview/widget/CardView;
    ...
    iget-object p1, v1, Lwn;->a:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1}, Lwn;->c()Z
    ...
    iget-boolean v2, p1, Lwo;->c:Z

    if-ne v2, p3, :cond_3

    iget-boolean v2, p1, Lwo;->d:Z
    ...
    iput-boolean p3, p1, Lwo;->c:Z

    iput-boolean v0, p1, Lwo;->d:Z

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Lwo;->a(Landroid/graphics/Rect;)V

    invoke-virtual {p1}, Lwo;->invalidateSelf()V
    ...
    invoke-virtual {v1, v3, v3, v3, v3}, Lwn;->a(IIII)V
    ...
    invoke-static {p2, p1, p3}, Lwp;->a(FFZ)F
    ...
    invoke-static {p2, p1, v0}, Lwp;->b(FFZ)F
    ...
    invoke-virtual {v1, p3, p1, p3, p1}, Lwn;->a(IIII)V
