...
# virtual methods
.method protected final ah(Lcny;)V
    .locals 1
...
.method protected final e()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lcod;-><init>(Landroid/os/Parcelable;)V

    iget-boolean v0, p0, Landroidx/preference/TwoStatePreference;->a:Z

    iput-boolean v0, v1, Lcod;->a:Z
...
.method protected final g(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p1}, Lcod;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Landroidx/preference/Preference;->g(Landroid/os/Parcelable;)V

    iget-boolean p1, p1, Lcod;->a:Z
...
.method protected final hD(Landroid/view/View;)V
    .locals 3
...
.method public k(Z)V
    ...
    iget-object v1, p0, Landroidx/preference/Preference;->k:Lcnv;

    invoke-virtual {v1}, Lcnv;->b()Landroid/content/SharedPreferences$Editor;
