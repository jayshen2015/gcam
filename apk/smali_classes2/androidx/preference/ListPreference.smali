...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {v0, v1, v2}, Lbyu;->m(Landroid/content/res/TypedArray;II)[Ljava/lang/CharSequence;
    ...
    invoke-static {v0, v1, v3}, Lbyu;->m(Landroid/content/res/TypedArray;II)[Ljava/lang/CharSequence;
    ...
    invoke-static {v0, v1, v1, v2}, Lbyu;->k(Landroid/content/res/TypedArray;IIZ)Z

    move-result v3

    if-eqz v3, :cond_1

    sget-object v3, Lcmx;->a:Lcmx;

    if-nez v3, :cond_0

    new-instance v3, Lcmx;

    invoke-direct {v3, v2}, Lcmx;-><init>(I)V

    sput-object v3, Lcmx;->a:Lcmx;

    :cond_0
    sget-object v2, Lcmx;->a:Lcmx;

    invoke-virtual {p0, v2}, Landroidx/preference/Preference;->R(Lcng;)V

    :cond_1
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    sget-object v0, Lcnz;->g:[I
...
.method protected final e()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lcmw;-><init>(Landroid/os/Parcelable;)V

    iget-object v0, p0, Landroidx/preference/ListPreference;->i:Ljava/lang/String;

    iput-object v0, v1, Lcmw;->a:Ljava/lang/String;
...
.method protected final g(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p1}, Lcmw;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Landroidx/preference/DialogPreference;->g(Landroid/os/Parcelable;)V

    iget-object p1, p1, Lcmw;->a:Ljava/lang/String;
