...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v1, p0, Landroidx/wear/widget/ArcLayout;->f:Lcua;

    const/4 v1, 0x0

    iput-object v1, p0, Landroidx/wear/widget/ArcLayout;->g:Landroid/view/View;

    sget-object v1, Lctt;->a:[I
...
.method private final a(Landroid/view/View;)F
    ...
    instance-of v1, p1, Landroidx/wear/widget/CurvedTextView;

    if-eqz v1, :cond_0

    check-cast p1, Landroidx/wear/widget/CurvedTextView;

    invoke-virtual {p1}, Landroidx/wear/widget/CurvedTextView;->a()I
    ...
    iget v3, v0, Lcub;->topMargin:I

    sub-int/2addr v2, v3

    iget v3, v0, Lcub;->bottomMargin:I
...
.method private final c(Landroid/view/View;Lcua;)V
    .locals 4
    ...
    iget p1, p1, Landroidx/wear/widget/CurvedTextView;->b:F
...
.method private final d(Landroid/view/View;F[F)V
    ...
    instance-of v2, p1, Landroidx/wear/widget/CurvedTextView;
...
.method protected final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    instance-of v2, p2, Landroidx/wear/widget/CurvedTextView;
    ...
    iget v1, v0, Landroidx/wear/widget/CurvedTextView;->c:I

    const/4 v2, -0x1

    if-ne v1, v2, :cond_1

    iget v0, v0, Landroidx/wear/widget/CurvedTextView;->d:F
    ...
    const-string p2, "CurvedTextView shall not set anchorAngleDegrees value when added into ArcLayout"
    ...
    const-string p2, "CurvedTextView shall not set anchorType value when added intoArcLayout"
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lcub;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected final generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lcub;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    instance-of v6, v3, Landroidx/wear/widget/CurvedTextView;

    if-eqz v6, :cond_1

    move-object v6, v3

    check-cast v6, Landroidx/wear/widget/CurvedTextView;

    invoke-virtual {v6, v4, v5}, Landroidx/wear/widget/CurvedTextView;->c(FF)Z
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object v11, v0, Landroidx/wear/widget/ArcLayout;->f:Lcua;

    invoke-direct {v0, v10, v11}, Landroidx/wear/widget/ArcLayout;->c(Landroid/view/View;Lcua;)V

    iget-object v10, v0, Landroidx/wear/widget/ArcLayout;->f:Lcua;

    invoke-virtual {v10}, Lcua;->a()F
    ...
    iget v11, v10, Lcua;->a:F

    iget v10, v10, Lcua;->b:F
    ...
    iget-object v9, v0, Landroidx/wear/widget/ArcLayout;->f:Lcua;

    invoke-direct {v0, v8, v9}, Landroidx/wear/widget/ArcLayout;->c(Landroid/view/View;Lcua;)V
    ...
    iget v10, v9, Lcub;->f:F

    cmpl-float v12, v10, v6

    if-lez v12, :cond_d

    iget-object v12, v0, Landroidx/wear/widget/ArcLayout;->f:Lcua;

    mul-float v10, v10, v5

    iput v10, v12, Lcua;->c:F

    instance-of v12, v8, Landroidx/wear/widget/CurvedTextView;

    if-eqz v12, :cond_c

    move-object v12, v8

    check-cast v12, Landroidx/wear/widget/CurvedTextView;

    iput v10, v12, Landroidx/wear/widget/CurvedTextView;->b:F
    ...
    iget v12, v10, Lcua;->a:F

    iget v10, v10, Lcua;->c:F
    ...
    iget-object v4, v0, Landroidx/wear/widget/ArcLayout;->f:Lcua;

    invoke-virtual {v4}, Lcua;->a()F

    move-result v4

    add-float/2addr v3, v4

    instance-of v4, v8, Landroidx/wear/widget/CurvedTextView;
...
.method protected final onMeasure(II)V
    ...
    :cond_3
    instance-of v9, v8, Landroidx/wear/widget/CurvedTextView;

    if-eqz v9, :cond_4

    move-object v9, v8

    check-cast v9, Landroidx/wear/widget/CurvedTextView;

    invoke-virtual {v9}, Landroidx/wear/widget/CurvedTextView;->a()I
    ...
    iget v10, v8, Lcub;->topMargin:I

    add-int/2addr v9, v10

    iget v8, v8, Lcub;->bottomMargin:I
    ...
    instance-of v6, v5, Landroidx/wear/widget/CurvedTextView;
