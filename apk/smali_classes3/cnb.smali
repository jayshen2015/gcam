...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcnb;->af:Ljava/util/Set;
...
.method public final A(Z)V
    ...
    iget-boolean p1, p0, Lcnb;->ag:Z

    if-eqz p1, :cond_0

    invoke-direct {p0}, Lcnb;->E()Landroidx/preference/MultiSelectListPreference;

    move-result-object p1

    iget-object v0, p0, Lcnb;->af:Ljava/util/Set;
...
.method protected final gq(Lek;)V
    ...
    iget-object v0, p0, Lcnb;->ai:[Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Lcnb;->af:Ljava/util/Set;

    iget-object v4, p0, Lcnb;->ai:[Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-object v0, p0, Lcnb;->ah:[Ljava/lang/CharSequence;

    new-instance v2, Lcna;

    invoke-direct {v2, p0}, Lcna;-><init>(Lcnb;)V

    iget-object p1, p1, Lek;->a:Leg;

    iput-object v0, p1, Leg;->n:[Ljava/lang/CharSequence;

    iput-object v2, p1, Leg;->w:Landroid/content/DialogInterface$OnMultiChoiceClickListener;

    iput-object v1, p1, Leg;->s:[Z

    const/4 v0, 0x1

    iput-boolean v0, p1, Leg;->t:Z
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcnb;->af:Ljava/util/Set;
...
.method public final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    sget-object v1, Lcom/google/android/apps/camera/hdrplus/deblurfusion/Vr/mWCZEc;->zJGFFGTCvKfexs:Ljava/lang/String;

    invoke-virtual {p1, v1, v0}, Landroid/os/Bundle;->putStringArrayList(Ljava/lang/String;Ljava/util/ArrayList;)V

    iget-boolean v0, p0, Lcnb;->ag:Z
    ...
    sget-object v1, Lcom/google/android/apps/camera/debugui/tvS/mUdMuJtYXsBO;->rtgG:Ljava/lang/String;
