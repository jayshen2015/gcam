...
.method private static requestFeatures(Landroid/content/Context;J[I[ILandroid/app/PendingIntent;)V
    ...
    invoke-static {p3}, Lqwv;->a([I)[Lqwv;

    move-result-object p3

    invoke-static {p4}, Lqwv;->a([I)[Lqwv;
    ...
    invoke-direct {v0, v1, v2}, Lqww;-><init>(J)V
    ...
    sget-object v2, Lqwn;->a:Landroid/content/ComponentName;
    ...
    invoke-virtual {v0, v6}, Lqww;->a(Lqwv;)Z

    move-result v7

    if-nez v7, :cond_0

    iget-object v6, v6, Lqwv;->d:Ljava/lang/String;
    ...
    sget-object v2, Lcom/google/android/gms/common/util/FUCQ/oeGNIrBkSq;->RyIhQfOegYQBV:Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lqww;->a(Lqwv;)Z

    move-result v5

    if-nez v5, :cond_3

    iget-object v3, v3, Lqwv;->d:Ljava/lang/String;
