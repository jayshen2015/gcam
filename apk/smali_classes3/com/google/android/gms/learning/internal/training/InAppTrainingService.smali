...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/learning/internal/training/InAppTrainingService;->dynamiteImpl:Lmao;

    if-eqz v0, :cond_0

    :try_start_0
    invoke-interface {v0, p1}, Lmao;->f(Landroid/content/Intent;)Landroid/os/IBinder;
...
.method public onCreate()V
    ...
    sget-object v3, Lmap;->d:Lmap;

    invoke-static {p0, v2, v3}, Lmae;->a(Landroid/content/Context;Ljava/lang/String;Lmad;)Landroid/os/IInterface;

    move-result-object v2

    check-cast v2, Lmao;
    :try_end_0
    .catch Lmac; {:try_start_0 .. :try_end_0} :catch_2
    ...
    invoke-interface {v2, v3}, Lmao;->g(Llxg;)V
    :try_end_1
    ...
    invoke-direct {v3, v4}, Lmag;-><init>(Landroid/content/Context;)V

    invoke-interface {v2, v3}, Lmao;->l(Lmaj;)V
    :try_end_2
    ...
    :cond_1
    :goto_1
    iput-object v2, p0, Lcom/google/android/gms/learning/internal/training/InAppTrainingService;->dynamiteImpl:Lmao;
...
.method public onRebind(Landroid/content/Intent;)V
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lmao;->i(Landroid/content/Intent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    :try_start_0
    invoke-interface {v0, p1, p2, p3}, Lmao;->e(Landroid/content/Intent;II)I
...
.method public onTrimMemory(I)V
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lmao;->j(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onUnbind(Landroid/content/Intent;)Z
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lmao;->k(Landroid/content/Intent;)Z
