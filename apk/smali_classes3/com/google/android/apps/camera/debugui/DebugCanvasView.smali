...
.field private volatile s:Landroid/hardware/camera2/params/MeteringRectangle;

.field private volatile t:Lpba;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->f:Landroid/graphics/Paint;

    new-instance p2, Landroid/graphics/Paint;

    invoke-direct {p2}, Landroid/graphics/Paint;-><init>()V

    iput-object p2, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->g:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->h:Landroid/graphics/Paint;

    new-instance v1, Landroid/graphics/Paint;

    invoke-direct {v1}, Landroid/graphics/Paint;-><init>()V

    iput-object v1, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->i:Landroid/graphics/Paint;

    new-instance v2, Landroid/graphics/Paint;

    invoke-direct {v2}, Landroid/graphics/Paint;-><init>()V

    iput-object v2, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->j:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Paint;

    invoke-direct {v3}, Landroid/graphics/Paint;-><init>()V

    iput-object v3, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->k:Landroid/graphics/Paint;

    new-instance v4, Landroid/graphics/Paint;

    invoke-direct {v4}, Landroid/graphics/Paint;-><init>()V

    iput-object v4, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->l:Landroid/graphics/Paint;

    new-instance v5, Landroid/graphics/Paint;

    invoke-direct {v5}, Landroid/graphics/Paint;-><init>()V

    iput-object v5, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->m:Landroid/graphics/Paint;

    new-instance v6, Landroid/graphics/Paint;

    invoke-direct {v6}, Landroid/graphics/Paint;-><init>()V

    iput-object v6, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->n:Landroid/graphics/Paint;

    new-instance v7, Landroid/graphics/Paint;

    invoke-direct {v7}, Landroid/graphics/Paint;-><init>()V

    iput-object v7, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->o:Landroid/graphics/Paint;

    sget v8, Lphh;->d:I

    sget-object v8, Lpkg;->a:Lphh;

    iput-object v8, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->p:Ljava/util/List;

    sget-object v8, Lpkg;->a:Lphh;

    iput-object v8, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->q:Ljava/util/List;

    sget-object v8, Lpkg;->a:Lphh;

    iput-object v8, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->r:Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->s:Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object p1, p0, Lcom/google/android/apps/camera/debugui/DebugCanvasView;->t:Lpba;
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object p1, p0, Lfre;->e:Lmqt;

    invoke-virtual {p1}, Lmqt;->f()Z
