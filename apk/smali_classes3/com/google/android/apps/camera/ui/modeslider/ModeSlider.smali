...
.method private final m(Landroid/widget/TextView;I)V
    ...
    invoke-direct {v1, p1}, Lkpf;-><init>(Landroid/widget/TextView;)V

    const v2, 0x7f09000c

    invoke-static {v0, v2, v1}, Lcan;->b(Landroid/content/Context;ILcal;)V
...
.method public final g()V
    ...
    :goto_0
    iget v2, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->c:I
...
.method public final h(Lkpg;)V
    ...
    iget-object v1, p1, Lkpg;->b:Ljava/util/List;

    invoke-interface {v0, v1}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    iget-object p1, p1, Lkpg;->b:Ljava/util/List;
    ...
    iget-object v4, v4, Lkph;->c:Ljava/lang/Object;
    ...
    iget-object v5, v5, Lkph;->d:Ljava/lang/Object;
    ...
    iget-object v7, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->f:Landroid/widget/LinearLayout$LayoutParams;
    ...
    invoke-static {v6, v4}, Loqp;->c(Landroid/view/View;I)I
    ...
    invoke-direct {v4, p0, v3, v5}, Ljis;-><init>(Landroid/view/ViewGroup;II)V
    ...
    invoke-direct {p1, p0, v0, v1}, Lelu;-><init>(Ljava/lang/Object;I[B)V
...
.method public final l(IZ)V
    ...
    invoke-static {v2, v4}, Loqp;->c(Landroid/view/View;I)I
    ...
    invoke-static {v2, v3}, Loqp;->c(Landroid/view/View;I)I
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->a:Lkpt;

    if-eqz v1, :cond_4

    if-nez p2, :cond_3

    invoke-interface {v1, v0}, Lkpt;->c(Z)V

    :cond_3
    iget-object v1, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->a:Lkpt;

    invoke-interface {v1, p0, p1, p2}, Lkpt;->a(Landroid/view/View;IZ)V

    if-nez p2, :cond_4

    iget-object p1, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->a:Lkpt;

    invoke-interface {p1, p0, v0}, Lkpt;->b(Landroid/view/View;Z)V
