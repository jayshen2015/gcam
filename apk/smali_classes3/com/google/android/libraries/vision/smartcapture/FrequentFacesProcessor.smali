...
.method public constructor <init>(Lqvc;)V
    ...
    iput-object p1, p0, Lcom/google/android/libraries/vision/smartcapture/FrequentFacesProcessor;->a:Lqnw;

    sget-object v0, Lqum;->j:Loip;

    invoke-virtual {p1, v0}, Lqnw;->d(Loip;)V
...
# virtual methods
.method public final declared-synchronized a(Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;IILjava/nio/ByteBuffer;IIIILquf;)Lquf;
    .locals 16
    ...
    :cond_0
    :try_start_1
    invoke-virtual/range {p12 .. p12}, Lqmt;->gB()[B
    ...
    sget-object v0, Lcom/google/android/apps/camera/facedeblur/deeprestore/jni/mYFC/YEQQXiRhra;->sxhfVXVA:Ljava/lang/String;
    ...
    :cond_1
    :try_start_2
    iget-object v2, v1, Lcom/google/android/libraries/vision/smartcapture/FrequentFacesProcessor;->a:Lqnw;

    sget-object v3, Lquf;->o:Lquf;

    array-length v4, v0

    const/4 v5, 0x0

    invoke-static {v3, v0, v5, v4, v2}, Lqoh;->v(Lqoh;[BIILqnw;)Lqoh;
