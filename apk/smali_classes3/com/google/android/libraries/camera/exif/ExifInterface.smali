...
.method public constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lmsn;-><init>(Ljava/nio/ByteOrder;)V

    iput-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lmsn;
...
.method private static final A(J)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lnvw;->Q(Ljava/lang/String;I)Ljava/lang/String;
...
.method public static w(D)[Lmpo;
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Lmpo;-><init>(JJ)V
    ...
    invoke-direct {v5, v8, v9, v6, v7}, Lmpo;-><init>(JJ)V
    ...
    invoke-direct {v5, p0, p1, v0, v1}, Lmpo;-><init>(JJ)V
...
.method private final z(Ljava/io/InputStream;Ljava/io/InputStream;)V
    .locals 6

    :try_start_0
    new-instance v0, Lmsu;

    invoke-direct {v0, p1, p0}, Lmsu;-><init>(Ljava/io/InputStream;Lcom/google/android/libraries/camera/exif/ExifInterface;)V

    new-instance p1, Lmsn;

    iget-object v1, v0, Lmsu;->a:Lmsm;

    iget-object v1, v1, Lmsm;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->order()Ljava/nio/ByteOrder;

    move-result-object v1

    invoke-direct {p1, v1}, Lmsn;-><init>(Ljava/nio/ByteOrder;)V

    invoke-virtual {v0}, Lmsu;->a()I

    move-result v1
    :try_end_0
    .catch Lmsp; {:try_start_0 .. :try_end_0} :catch_1
    ...
    :try_start_1
    iget-object v1, v0, Lmsu;->e:Lmsv;

    goto/16 :goto_2

    :pswitch_0
    iget-object v1, v0, Lmsu;->f:Lmsv;
    ...
    :cond_0
    invoke-virtual {v1, v3}, Lmsv;->b(I)J
    ...
    invoke-virtual {v0, v1}, Lmsu;->b([B)I

    move-result v4

    if-ne v3, v4, :cond_1

    iput-object v1, p1, Lmsn;->b:[B
    ...
    :pswitch_1
    iget-object v1, v0, Lmsu;->c:Lmsv;

    if-eqz v1, :cond_8

    iget-short v2, v1, Lmsv;->b:S

    const/4 v3, 0x7

    if-ne v2, v3, :cond_2

    invoke-virtual {v0, v1}, Lmsu;->e(Lmsv;)V

    :cond_2
    iget v2, v1, Lmsv;->e:I

    invoke-virtual {p1, v2}, Lmsn;->b(I)Lmsy;

    move-result-object v2

    if-eqz v2, :cond_8

    invoke-virtual {v2, v1}, Lmsy;->e(Lmsv;)V
    ...
    iget-object v3, v0, Lmsu;->a:Lmsm;

    iget v3, v3, Lmsm;->a:I

    if-lt v2, v3, :cond_8

    iget-object v3, v0, Lmsu;->g:Ljava/util/TreeMap;
    ...
    invoke-direct {v4, v1, v5}, Lmsr;-><init>(Lmsv;Z)V
    ...
    invoke-direct {v1, v2}, Lmsy;-><init>(I)V

    invoke-virtual {p1, v1}, Lmsn;->d(Lmsy;)V
    ...
    iget-object v2, v0, Lmsu;->d:Lmst;

    iget v2, v2, Lmst;->a:I

    iget-object v3, p1, Lmsn;->c:Ljava/util/ArrayList;
    ...
    iget-object v4, p1, Lmsn;->c:Ljava/util/ArrayList;
    ...
    :cond_6
    iget-object v2, p1, Lmsn;->c:Ljava/util/ArrayList;
    ...
    move-result v1
    :try_end_1
    .catch Lmsp; {:try_start_1 .. :try_end_1} :catch_1

    goto/16 :goto_0

    :cond_9
    iput-object p1, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lmsn;
    ...
    :cond_a
    invoke-static {p2}, Lngj;->e(Ljava/io/InputStream;)Lpce;
    ...
    iget-object v0, p1, Lpce;->a:Ljava/lang/Object;

    check-cast v0, Ldev;

    invoke-static {v0}, Lngj;->f(Ldev;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p1}, Lngj;->f(Ldev;)Ljava/nio/ByteBuffer;
    ...
    iput-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bA:Ljava/lang/String;
    :try_end_2
    .catch Ldeu; {:try_start_2 .. :try_end_2} :catch_0
    ...
    const-string v0, "Could not parse XMP data."
...
.method public final a(I)Lmpo;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->v(II)[Lmpo;
    ...
    invoke-direct {v0, p1}, Lmpo;-><init>(Lmpo;)V
...
.method public final b(I)Ljava/lang/Integer;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->l(II)Lmsv;
...
.method public getTagStringValue(I)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p1}, Lmsv;->d()Ljava/lang/String;
...
.method public final i(ILjava/lang/Object;)Lmsv;
    .locals 9
    ...
    invoke-direct/range {v1 .. v6}, Lmsv;-><init>(SSIIZ)V
    ...
    invoke-virtual {p1, p2}, Lmsv;->g(I)Z
    ...
    invoke-virtual {p1, p2}, Lmsv;->h(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, p2}, Lmsv;->j([I)Z
    ...
    invoke-virtual {p1, p2}, Lmsv;->k([J)Z
    ...
    :cond_5
    instance-of v0, p2, Lmpo;

    if-eqz v0, :cond_6

    check-cast p2, Lmpo;

    new-array v0, v7, [Lmpo;

    aput-object p2, v0, v8

    invoke-virtual {p1, v0}, Lmsv;->l([Lmpo;)Z
    ...
    invoke-virtual {p1, p2}, Lmsv;->l([Lmpo;)Z
    ...
    invoke-virtual {p1, p2}, Lmsv;->i([B)Z
    ...
    :cond_d
    invoke-virtual {p1, v0}, Lmsv;->j([I)Z
    ...
    :cond_13
    invoke-virtual {p1, v0}, Lmsv;->k([J)Z
...
.method public final j(I)Lmsv;
    ...
    invoke-direct/range {v0 .. v5}, Lmsv;-><init>(SSIIZ)V

    return-object p1
.end method

.method public final k(I)Lmsv;
    .locals 1
...
.method public final l(II)Lmsv;
    .locals 2

    invoke-static {p2}, Lmsv;->f(I)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lmsn;

    invoke-static {p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->n(I)S

    move-result p1

    iget-object v0, v0, Lmsn;->a:[Lmsy;
    ...
    :cond_1
    invoke-virtual {p2, p1}, Lmsy;->b(S)Lmsv;
...
.method public final m(Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    iget-object p1, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lmsn;

    invoke-direct {v1, v2, p0, p1}, Lmsw;-><init>(Ljava/io/OutputStream;Lcom/google/android/libraries/camera/exif/ExifInterface;Lmsn;)V

    invoke-direct {v0, v1}, Lmtc;-><init>(Lmtb;)V
...
.method public final p(I)V
    ...
    iget-object v1, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lmsn;

    invoke-static {p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->n(I)S

    move-result p1

    invoke-virtual {v1, p1, v0}, Lmsn;->h(SI)Z
...
.method public final r([BZ)V
    ...
    :goto_0
    invoke-direct {p0, v0, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->z(Ljava/io/InputStream;Ljava/io/InputStream;)V
...
.method public readExif(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->z(Ljava/io/InputStream;Ljava/io/InputStream;)V
    ...
    sget-object v0, Lcom/google/android/apps/camera/optionsbar/view/feZT/uXNsotqsQJ;->vdK:Ljava/lang/String;
...
.method public final v(II)[Lmpo;
    .locals 1

    invoke-virtual {p0, p1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->l(II)Lmsv;
    ...
    :cond_0
    iget-object p1, p1, Lmsv;->f:Ljava/lang/Object;
...
.method public final x(IJLjava/util/TimeZone;)V
    ...
    invoke-virtual {p0, p1, v2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->i(ILjava/lang/Object;)Lmsv;
    ...
    :cond_2
    invoke-virtual {p0, v2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->y(Lmsv;)V
    ...
    invoke-virtual {p0, v1, p4}, Lcom/google/android/libraries/camera/exif/ExifInterface;->i(ILjava/lang/Object;)Lmsv;

    move-result-object p4

    if-eqz p4, :cond_6

    invoke-virtual {p0, p4}, Lcom/google/android/libraries/camera/exif/ExifInterface;->y(Lmsv;)V
    ...
    :goto_3
    invoke-static {p2, p3}, Lnie;->aF(J)Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p0, p1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->i(ILjava/lang/Object;)Lmsv;
    ...
    :cond_9
    invoke-virtual {p0, p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->y(Lmsv;)V

    return-void

    :cond_a
    const-string p2, "Must pass a date stamp tag, unrecognized tag: "
...
.method public final y(Lmsv;)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lmsn;

    invoke-virtual {v0, p1}, Lmsn;->j(Lmsv;)V
