...
# instance fields
.field private blendMode:Llob;

.field private final contentPaint:Landroid/graphics/Paint;

.field private contentProvider:Lccd;
...
.method public constructor <init>()V
    ...
    iput-object v2, p0, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->blendMode:Llob;
...
.method public static create(Landroid/graphics/drawable/Drawable;)Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;
    ...
    invoke-static {p0, v0}, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->create(Landroid/graphics/drawable/Drawable;Llob;)Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;
...
.method public static create(Landroid/graphics/drawable/Drawable;Llob;)Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->initialize(Landroid/graphics/drawable/Drawable;Llob;)V

    return-object v0
.end method

.method private draw(Landroid/graphics/Canvas;Lccd;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->drawWithAlphaBlending(Landroid/graphics/Canvas;Lccd;)V
...
.method private drawWithAlphaBlending(Landroid/graphics/Canvas;Lccd;)V
    .locals 2
...
.method private initialize(Landroid/graphics/drawable/Drawable;Llob;)V
    .locals 0
    ...
    invoke-virtual {p0, p2}, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->setBlendMode(Llob;)V
...
.method private useAlphaChannelBlending()Z
    ...
    iget-object v0, p0, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->blendMode:Llob;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->contentProvider:Lccd;

    if-eqz v0, :cond_0

    invoke-direct {p0, p1, v0}, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->draw(Landroid/graphics/Canvas;Lccd;)V
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    sget-object p2, Llob;->a:Llob;

    goto :goto_1

    :pswitch_0
    sget-object p2, Llob;->c:Llob;

    goto :goto_1

    :pswitch_1
    sget-object p2, Llob;->b:Llob;
...
.method public setBlendMode(Llob;)V
    .locals 2

    iput-object p1, p0, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->blendMode:Llob;

    new-instance v0, Landroid/graphics/PorterDuffXfermode;

    sget-object v1, Llob;->a:Llob;

    iget-object p1, p1, Llob;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {v0, p1}, Landroid/graphics/PorterDuffXfermode;-><init>(Landroid/graphics/PorterDuff$Mode;)V

    iget-object p1, p0, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->drawablePaint:Landroid/graphics/Paint;
...
.method public setContentProvider(Lccd;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/google/android/clockwork/common/wearable/wearmaterial/util/BlendContentDrawable;->contentProvider:Lccd;
