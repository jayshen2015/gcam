...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    new-instance v8, Llnx;

    invoke-direct {v8, v7}, Llnx;-><init>(I)V
    ...
    invoke-direct {v6, v4, v5}, Llnw;-><init>(Landroid/view/View;Landroid/view/View;)V

    iput-object v6, p0, Lcom/google/android/clockwork/common/wearable/wearmaterial/slider/WearInlineSlider;->j:Llnw;
    ...
    iput-object v7, v6, Llnw;->e:Landroidx/wear/ambient/AmbientMode$AmbientController;
    ...
    iput-boolean p3, v6, Llnw;->a:Z

    invoke-virtual {v6}, Llnw;->a()V
...
.method private final m(FZ)V
    ...
    invoke-static {p1, v1, v3}, Lnie;->dm(FFF)F
    ...
    :goto_2
    iget-object p1, v4, Landroidx/preference/Preference;->o:Lcne;

    if-eqz p1, :cond_4

    invoke-interface {p1}, Lcne;->a()Z
    ...
    :cond_4
    iget-object p1, v4, Landroidx/preference/Preference;->k:Lcnv;

    if-eqz p1, :cond_5

    iget-object p1, p1, Lcnv;->c:Lcnp;

    if-eqz p1, :cond_5

    invoke-virtual {p1, v4}, Lcnp;->B(Landroidx/preference/Preference;)Z
    ...
    iget-object p2, p0, Lcom/google/android/clockwork/common/wearable/wearmaterial/slider/WearInlineSlider;->i:Lcom/google/android/clockwork/common/wearable/wearmaterial/slider/SliderProgressDrawable;
...
.method public final j()V
    ...
    iget-object v0, p0, Lcom/google/android/clockwork/common/wearable/wearmaterial/slider/WearInlineSlider;->j:Llnw;
