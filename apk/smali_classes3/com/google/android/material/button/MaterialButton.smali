...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v2, v4}, La;->l(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v2, v1, v4}, Lovp;->k(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, v1, v4}, Lovp;->l(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v11, v7, v8, v9}, Lovw;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Lovv;

    move-result-object v2

    invoke-virtual {v2}, Lovv;->a()Lovw;

    move-result-object v2

    new-instance v5, Lort;

    invoke-direct {v5, v0, v2}, Lort;-><init>(Lcom/google/android/material/button/MaterialButton;Lovw;)V

    iput-object v5, v0, Lcom/google/android/material/button/MaterialButton;->d:Lort;
    ...
    iget-object v7, v5, Lort;->b:Lovw;

    int-to-float v6, v6

    invoke-virtual {v7, v6}, Lovw;->d(F)Lovw;

    move-result-object v6

    invoke-virtual {v5, v6}, Lort;->d(Lovw;)V
    ...
    invoke-static {v6, v7}, La;->l(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v6

    iput-object v6, v5, Lort;->i:Landroid/graphics/PorterDuff$Mode;

    iget-object v6, v5, Lort;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    invoke-static {v6, v1, v7}, Lovp;->k(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v6

    iput-object v6, v5, Lort;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object v6, v5, Lort;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object v6, v5, Lort;->l:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v6, v5, Lort;->p:Z

    iget-object v6, v5, Lort;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-static {v6}, Lcdj;->e(Landroid/view/View;)I

    move-result v6

    iget-object v7, v5, Lort;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-virtual {v7}, Lcom/google/android/material/button/MaterialButton;->getPaddingTop()I

    move-result v7

    iget-object v8, v5, Lort;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-static {v8}, Lcdj;->d(Landroid/view/View;)I

    move-result v8

    iget-object v9, v5, Lort;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    invoke-virtual {v5}, Lort;->c()V

    goto/16 :goto_0

    :cond_1
    new-instance v11, Lovr;

    iget-object v12, v5, Lort;->b:Lovw;

    invoke-direct {v11, v12}, Lovr;-><init>(Lovw;)V

    iget-object v12, v5, Lort;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-virtual {v12}, Lcom/google/android/material/button/MaterialButton;->getContext()Landroid/content/Context;

    move-result-object v12

    invoke-virtual {v11, v12}, Lovr;->h(Landroid/content/Context;)V

    iget-object v12, v5, Lort;->j:Landroid/content/res/ColorStateList;

    invoke-static {v11, v12}, Lcav;->g(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    iget-object v12, v5, Lort;->i:Landroid/graphics/PorterDuff$Mode;

    if-eqz v12, :cond_2

    invoke-static {v11, v12}, Lcav;->h(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V

    :cond_2
    iget-object v12, v5, Lort;->a:Lcom/google/android/material/button/MaterialButton;

    iget v13, v5, Lort;->h:I

    int-to-float v13, v13

    iget-object v14, v5, Lort;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {v11, v13}, Lovr;->m(F)V

    invoke-virtual {v11, v14}, Lovr;->l(Landroid/content/res/ColorStateList;)V

    new-instance v13, Lovr;

    iget-object v14, v5, Lort;->b:Lovw;

    invoke-direct {v13, v14}, Lovr;-><init>(Lovw;)V

    invoke-virtual {v13, v10}, Lovr;->setTint(I)V

    iget v14, v5, Lort;->h:I

    int-to-float v14, v14

    invoke-virtual {v13, v14}, Lovr;->m(F)V

    invoke-static {v10}, Landroid/content/res/ColorStateList;->valueOf(I)Landroid/content/res/ColorStateList;

    move-result-object v14

    invoke-virtual {v13, v14}, Lovr;->l(Landroid/content/res/ColorStateList;)V

    new-instance v14, Lovr;

    iget-object v15, v5, Lort;->b:Lovw;

    invoke-direct {v14, v15}, Lovr;-><init>(Lovw;)V

    iput-object v14, v5, Lort;->m:Landroid/graphics/drawable/Drawable;

    iget-object v14, v5, Lort;->m:Landroid/graphics/drawable/Drawable;

    invoke-static {v14, v3}, Lcav;->f(Landroid/graphics/drawable/Drawable;I)V

    new-instance v3, Landroid/graphics/drawable/RippleDrawable;

    iget-object v14, v5, Lort;->l:Landroid/content/res/ColorStateList;

    invoke-static {v14}, Lovj;->b(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    iget v11, v5, Lort;->c:I

    iget v13, v5, Lort;->e:I

    iget v4, v5, Lort;->d:I

    iget v10, v5, Lort;->f:I
    ...
    iget-object v4, v5, Lort;->m:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v3, v5, Lort;->q:Landroid/graphics/drawable/LayerDrawable;

    iget-object v2, v5, Lort;->q:Landroid/graphics/drawable/LayerDrawable;

    invoke-super {v12, v2}, Landroid/support/v7/widget/AppCompatButton;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v5}, Lort;->a()Lovr;
    ...
    invoke-virtual {v2, v3}, Lovr;->i(F)V

    iget-object v3, v5, Lort;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-virtual {v3}, Lcom/google/android/material/button/MaterialButton;->getDrawableState()[I

    move-result-object v3

    invoke-virtual {v2, v3}, Lovr;->setState([I)Z

    :cond_3
    :goto_0
    iget-object v2, v5, Lort;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    invoke-static {v2, v6, v7, v8, v9}, Lcdj;->j(Landroid/view/View;IIII)V
...
.method private final a()V
    ...
    invoke-static {p0, v0, v1, v1}, Lcer;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, v1, v1, v0}, Lcer;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, v1, v0, v1}, Lcer;->e(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method private final g(Z)V
    ...
    invoke-static {v2, v0}, Lcav;->h(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0}, Lcgj;->h(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;
...
.method private final h(II)V
    ...
    invoke-static {p0}, Lcdj;->d(Landroid/view/View;)I
    ...
    invoke-static {p0}, Lcdj;->e(Landroid/view/View;)I
...
.method private final l()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lort;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lort;->n:Z
...
.method public final c(Lovw;)V
    ...
    invoke-virtual {v0, p1}, Lort;->d(Lovw;)V
...
.method public final d(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lort;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Lort;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {v0}, Lort;->a()Lovr;
    ...
    iget-object v0, v0, Lort;->j:Landroid/content/res/ColorStateList;
...
.method public final e(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, Lort;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Lort;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p1, v0, Lort;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Lort;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lors;-><init>(Landroid/os/Parcelable;)V

    iget-boolean v0, p0, Lcom/google/android/material/button/MaterialButton;->m:Z

    iput-boolean v0, v1, Lors;->a:Z
...
.method public final setBackgroundColor(I)V
    ...
    invoke-virtual {v0, p1}, Lovr;->setTint(I)V
