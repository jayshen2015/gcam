...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v9, Lotg;

    invoke-direct {v9, p0}, Lotg;-><init>(Landroid/view/View;)V

    iput-object v9, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lotg;

    sget-object v2, Loqd;->e:Landroid/animation/TimeInterpolator;

    iput-object v2, v9, Lotg;->C:Landroid/animation/TimeInterpolator;

    invoke-virtual {v9}, Lotg;->f()V

    iput-boolean v1, v9, Lotg;->x:Z

    new-instance v10, Losh;

    invoke-direct {v10, v8}, Losh;-><init>(Landroid/content/Context;)V

    iput-object v10, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->b:Losh;

    sget-object v4, Loqx;->c:[I
    ...
    invoke-virtual {v9, p3}, Lotg;->i(I)V

    const p3, 0x7f1502d4

    invoke-virtual {v9, p3}, Lotg;->h(I)V
    ...
    :goto_0
    iput-object p3, v9, Lotg;->u:Landroid/text/TextUtils$TruncateAt;
    ...
    invoke-static {v8, p2, p3}, Lovp;->k(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p3

    iget-object v2, v9, Lotg;->l:Landroid/content/res/ColorStateList;

    if-eq v2, p3, :cond_9

    iput-object p3, v9, Lotg;->l:Landroid/content/res/ColorStateList;
    ...
    iget-object v2, v9, Lotg;->m:Landroid/content/res/ColorStateList;

    if-eq v2, p3, :cond_a

    iput-object p3, v9, Lotg;->m:Landroid/content/res/ColorStateList;
    ...
    iput-object p3, v9, Lotg;->B:Landroid/animation/TimeInterpolator;
    ...
    sget-object p3, Loqd;->c:Landroid/animation/TimeInterpolator;

    const v2, 0x7f0404c6

    invoke-static {v8, v2, p3}, Loqp;->k(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;

    move-result-object p3

    iput-object p3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->w:Landroid/animation/TimeInterpolator;

    sget-object p3, Loqd;->d:Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, v2}, Lcaw;->b(Landroid/graphics/drawable/Drawable;I)Z
    ...
    iget p3, v10, Losh;->b:I

    invoke-virtual {v10, p3, p1}, Losh;->b(IF)I
    ...
    invoke-direct {p1, p0}, Loqs;-><init>(Lcom/google/android/material/appbar/CollapsingToolbarLayout;)V
...
.method protected static final g()Loqt;
    .locals 1
...
.method static h(Landroid/view/View;)Lqno;
    .locals 2
    ...
    invoke-direct {v1, p0}, Lqno;-><init>(Landroid/view/View;)V
...
.method private final n(IIIIZ)V
    ...
    invoke-static {p0, v7, v8}, Loth;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    :goto_3
    iget-object v10, v0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lotg;
    ...
    iget-object v6, v10, Lotg;->h:Landroid/graphics/Rect;

    invoke-static {v6, v11, v12, v4, v2}, Lotg;->j(Landroid/graphics/Rect;IIII)Z
    ...
    iput-boolean v3, v10, Lotg;->z:Z

    :cond_8
    iget-object v2, v0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lotg;
    ...
    iget-object v8, v2, Lotg;->g:Landroid/graphics/Rect;

    invoke-static {v8, v4, v6, v7, v5}, Lotg;->j(Landroid/graphics/Rect;IIII)Z
    ...
    iput-boolean v3, v2, Lotg;->z:Z

    :cond_b
    iget-object v2, v0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lotg;

    invoke-virtual {v2, v1}, Lotg;->g(Z)V
...
.method private final o()V
    ...
    iget-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lotg;

    iget-object v0, v0, Lotg;->v:Ljava/lang/CharSequence;
...
.method final a(Landroid/view/View;)I
    ...
    invoke-static {p1}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->h(Landroid/view/View;)Lqno;
    ...
    iget p1, v1, Loqt;->bottomMargin:I
...
.method public final b()I
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->e:Lcez;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lotg;

    invoke-virtual {v1, p1}, Lotg;->d(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0, p1}, Lotg;->d(Landroid/graphics/Canvas;)V
...
.method protected final drawableStateChanged()V
    ...
    :cond_1
    iget-object v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lotg;

    if-eqz v3, :cond_5

    iput-object v0, v3, Lotg;->y:[I

    iget-object v0, v3, Lotg;->m:Landroid/content/res/ColorStateList;
    ...
    :cond_2
    iget-object v0, v3, Lotg;->l:Landroid/content/res/ColorStateList;
...
.method public final e(Ljava/lang/CharSequence;)V
    ...
    iget-object v2, v0, Lotg;->v:Ljava/lang/CharSequence;
    ...
    :cond_0
    iput-object p1, v0, Lotg;->v:Ljava/lang/CharSequence;

    iput-object v1, v0, Lotg;->w:Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lotg;

    iget-object v1, p1, Lotg;->v:Ljava/lang/CharSequence;
...
.method final f()V
    ...
    invoke-direct {v1, p0, v2}, Lore;-><init>(Ljava/lang/Object;I)V
...
.method protected final bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-static {}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->g()Loqt;
...
.method protected final bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Loqt;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Loqt;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, p1}, Lotg;->e(Landroid/content/res/Configuration;)V
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->e:Lcez;
    ...
    invoke-static {v2}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->h(Landroid/view/View;)Lqno;

    move-result-object v2

    invoke-virtual {v2}, Lqno;->R()V
    ...
    invoke-static {p2}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->h(Landroid/view/View;)Lqno;

    move-result-object p2

    invoke-virtual {p2}, Lqno;->Q()V
...
.method protected final onMeasure(II)V
    ...
    iget-object p2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lotg;
    ...
    iget-object v0, p2, Lotg;->A:Landroid/text/TextPaint;

    iget v3, p2, Lotg;->k:F

    invoke-virtual {v0, v3}, Landroid/text/TextPaint;->setTextSize(F)V

    iget-object v3, p2, Lotg;->r:Landroid/graphics/Typeface;
    ...
    iget-object p2, p2, Lotg;->A:Landroid/text/TextPaint;
