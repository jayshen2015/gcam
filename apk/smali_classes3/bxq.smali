...
.method public constructor <init>(Landroid/content/Context;Landroidx/constraintlayout/widget/ConstraintLayout;I)V
    ...
    iput-object v0, p0, Lbxq;->d:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, Lbxq;->f:Landroid/util/SparseArray;

    const/4 v0, 0x0

    iput-object v0, p0, Lbxq;->e:Lbxz;

    iput-object p2, p0, Lbxq;->a:Landroidx/constraintlayout/widget/ConstraintLayout;

    invoke-direct {p0, p1, p3}, Lbxq;->a(Landroid/content/Context;I)V
...
.method private final a(Landroid/content/Context;I)V
    ...
    :goto_5
    invoke-virtual {v4, p1, v3}, Lbxx;->l(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v6, p0, Lbxq;->f:Landroid/util/SparseArray;
    ...
    invoke-direct {v4, p1, v3}, Lbxp;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    if-eqz v5, :cond_6

    iget-object v6, v5, Lbxo;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v4, p1, v3}, Lbxo;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v5, p0, Lbxq;->d:Landroid/util/SparseArray;
