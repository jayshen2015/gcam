...
.field private final Q:Ljt;

.field private final R:Landroid/graphics/Rect;

.field private S:Lbma;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lnj;-><init>(Ljava/lang/Class;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v3}, Lnl;->d(Landroid/view/View;Landroid/content/Context;)V
    ...
    sget-object v4, Lfw;->v:[I

    invoke-static {p1, p2, v4, p3, v1}, Landroidx/wear/ambient/AmbientDelegate;->E(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/wear/ambient/AmbientDelegate;

    move-result-object v4

    sget-object v7, Lfw;->v:[I
    ...
    invoke-virtual {v4, v5}, Landroidx/wear/ambient/AmbientDelegate;->v(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, v6}, Landroidx/wear/ambient/AmbientDelegate;->v(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-virtual {v4, v1}, Landroidx/wear/ambient/AmbientDelegate;->x(I)Ljava/lang/CharSequence;

    move-result-object v6

    invoke-virtual {p0, v6}, Landroid/support/v7/widget/SwitchCompat;->e(Ljava/lang/CharSequence;)V

    invoke-virtual {v4, v2}, Landroidx/wear/ambient/AmbientDelegate;->x(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v4, v6, v2}, Landroidx/wear/ambient/AmbientDelegate;->A(IZ)Z
    ...
    invoke-virtual {v4, v7, v1}, Landroidx/wear/ambient/AmbientDelegate;->p(II)I
    ...
    invoke-virtual {v4, v7, v1}, Landroidx/wear/ambient/AmbientDelegate;->A(IZ)Z
    ...
    invoke-virtual {v4, v7}, Landroidx/wear/ambient/AmbientDelegate;->u(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v7, v8}, Landroidx/wear/ambient/AmbientDelegate;->q(II)I

    move-result v7

    invoke-static {v7, v0}, La;->l(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v7, v9}, Lcav;->g(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v7, v9}, Lcav;->h(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v4, v7, v1}, Landroidx/wear/ambient/AmbientDelegate;->t(II)I

    move-result v7

    if-eqz v7, :cond_18

    sget-object v9, Lfw;->w:[I

    invoke-static {p1, v7, v9}, Landroidx/wear/ambient/AmbientDelegate;->C(Landroid/content/Context;I[I)Landroidx/wear/ambient/AmbientDelegate;

    move-result-object v7

    invoke-virtual {v7, v6}, Landroidx/wear/ambient/AmbientDelegate;->u(I)Landroid/content/res/ColorStateList;
    ...
    :goto_0
    invoke-virtual {v7, v1, v1}, Landroidx/wear/ambient/AmbientDelegate;->p(II)I
    ...
    :cond_11
    invoke-virtual {v7, v2, v8}, Landroidx/wear/ambient/AmbientDelegate;->q(II)I

    move-result v6

    invoke-virtual {v7, v5, v8}, Landroidx/wear/ambient/AmbientDelegate;->q(II)I
    ...
    invoke-virtual {v7, v2, v1}, Landroidx/wear/ambient/AmbientDelegate;->A(IZ)Z
    ...
    invoke-direct {v0, p0}, Ljt;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->Q:Ljt;

    invoke-virtual {v0, p2, p3}, Ljt;->b(Landroid/util/AttributeSet;I)V

    invoke-virtual {v4}, Landroidx/wear/ambient/AmbientDelegate;->z()V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/SwitchCompat;->m()Lbma;
...
.method private final h()I
    ...
    invoke-static {v0}, Lkl;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method private final k()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->S:Lbma;
...
.method private final m()Lbma;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SwitchCompat;->S:Lbma;
...
.method public final a()V
    ...
    :cond_0
    invoke-static {p0, v0}, Lcdv;->d(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Lkl;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Lkl;->a:Landroid/graphics/Rect;
    ...
    invoke-static {v2, v0, v1, v4, v3}, Lcav;->e(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public final drawableHotspotChanged(FF)V
    ...
    invoke-static {v0, p1, p2}, Lcav;->d(Landroid/graphics/drawable/Drawable;FF)V
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Lkl;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-static {p3}, Lkl;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public final setChecked(Z)V
    ...
    invoke-static {p1, v0}, Lnk;->a(Landroid/animation/ObjectAnimator;Z)V
