...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, p0, v3}, Lnq;-><init>(Ljava/lang/Object;I)V

    invoke-direct {v1, v2}, Lvd;-><init>(Ljava/lang/Runnable;)V

    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->C:Lvd;
    ...
    invoke-direct {v1, p0, v4, v2}, Lnq;-><init>(Ljava/lang/Object;I[B)V
    ...
    sget-object v2, Lfw;->x:[I

    invoke-static {v1, p2, v2, p3, v3}, Landroidx/wear/ambient/AmbientDelegate;->E(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/wear/ambient/AmbientDelegate;

    move-result-object v1

    sget-object v7, Lfw;->x:[I
    ...
    invoke-virtual {v1, p1, v3}, Landroidx/wear/ambient/AmbientDelegate;->t(II)I
    ...
    invoke-virtual {v1, v3, p1}, Landroidx/wear/ambient/AmbientDelegate;->r(II)I
    ...
    invoke-virtual {v1, v0, p1}, Landroidx/wear/ambient/AmbientDelegate;->r(II)I
    ...
    invoke-virtual {v1, p1, v3}, Landroidx/wear/ambient/AmbientDelegate;->o(II)I

    move-result p1

    const/16 p2, 0x1b

    invoke-virtual {v1, p2}, Landroidx/wear/ambient/AmbientDelegate;->B(I)Z

    move-result p3

    if-eqz p3, :cond_0

    invoke-virtual {v1, p2, p1}, Landroidx/wear/ambient/AmbientDelegate;->o(II)I
    ...
    invoke-virtual {v1, p1, p2}, Landroidx/wear/ambient/AmbientDelegate;->p(II)I
    ...
    invoke-virtual {v1, p3, p2}, Landroidx/wear/ambient/AmbientDelegate;->o(II)I

    move-result p3

    const/4 v0, 0x7

    invoke-virtual {v1, v0, v3}, Landroidx/wear/ambient/AmbientDelegate;->p(II)I
    ...
    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->s:Lmz;

    iput-boolean v3, v5, Lmz;->h:Z
    ...
    :cond_7
    invoke-virtual {v5, p1, p3}, Lmz;->a(II)V
    ...
    invoke-virtual {v1, p1}, Landroidx/wear/ambient/AmbientDelegate;->v(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->f:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v4}, Landroidx/wear/ambient/AmbientDelegate;->x(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, p1}, Landroidx/wear/ambient/AmbientDelegate;->x(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, p1}, Landroidx/wear/ambient/AmbientDelegate;->B(I)Z

    move-result p2

    if-eqz p2, :cond_10

    invoke-virtual {v1, p1}, Landroidx/wear/ambient/AmbientDelegate;->u(I)Landroid/content/res/ColorStateList;
...
.method protected static final A(Landroid/view/ViewGroup$LayoutParams;)Lnu;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lnu;-><init>(Leb;)V
...
.method private final H(Landroid/view/View;Z)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/Toolbar;->A(Landroid/view/ViewGroup$LayoutParams;)Lnu;
...
.method private static final L(Landroid/view/View;)I
    ...
    invoke-static {p0}, Lccu;->c(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v0

    invoke-static {p0}, Lccu;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method public static final z()Lnu;
    .locals 1
...
.method public final a()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->s:Lmz;

    if-eqz v0, :cond_1

    iget-boolean v1, v0, Lmz;->g:Z
...
.method public final c()I
    ...
    invoke-virtual {v0}, Lhb;->hasVisibleItems()Z
...
.method public final f()Landroid/view/Menu;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/ActionMenuView;->a:Lhb;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->y:Lnt;

    if-nez v1, :cond_0

    new-instance v1, Lnt;

    invoke-direct {v1, p0}, Lnt;-><init>(Landroid/support/v7/widget/Toolbar;)V

    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->y:Lnt;

    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->a:Landroid/support/v7/widget/ActionMenuView;

    iget-object v1, v1, Landroid/support/v7/widget/ActionMenuView;->c:Lih;
...
.method protected final bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-static {p1}, Landroid/support/v7/widget/Toolbar;->A(Landroid/view/ViewGroup$LayoutParams;)Lnu;
...
.method public final j()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->y:Lnt;
    ...
    :cond_0
    iget-object v0, v0, Lnt;->b:Lhd;

    :goto_0
    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lhd;->collapseActionView()Z
...
.method public final k()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->s:Lmz;
...
.method public final l()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->z:Lhn;
...
.method public final m()V
    ...
    invoke-direct {v0, v1, v2, v3}, Liu;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Lcdi;->b(Landroid/view/View;)I
    ...
    iget-object v8, v0, Landroid/support/v7/widget/Toolbar;->b:Landroid/widget/TextView;

    invoke-virtual {v8, v4, v3, v6, v5}, Landroid/widget/TextView;->layout(IIII)V
    ...
    invoke-virtual {v9, v5, v3, v6, v8}, Landroid/widget/TextView;->layout(IIII)V
    ...
    invoke-virtual {v9, v5, v3, v4, v8}, Landroid/widget/TextView;->layout(IIII)V
    ...
    invoke-virtual {v10, v5, v3, v8, v9}, Landroid/widget/TextView;->layout(IIII)V
...
.method protected final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->y:Lnt;
...
.method public final onRtlPropertiesChanged(I)V
    ...
    :cond_1
    iput-boolean v2, v0, Lmz;->g:Z

    iget-boolean p1, v0, Lmz;->h:Z
...
.method protected final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Lnv;-><init>(Landroid/os/Parcelable;)V

    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->y:Lnt;

    if-eqz v1, :cond_0

    iget-object v1, v1, Lnt;->b:Lhd;
...
.method public final p(Ljava/lang/CharSequence;)V
    ...
    invoke-static {v0, p1}, Lnz;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final s(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v1, v0}, Ljx;-><init>(Landroid/content/Context;)V
...
.method public final u()V
    ...
    :try_start_0
    invoke-static {p0}, Lns;->b(Landroid/view/View;)Landroid/window/OnBackInvokedDispatcher;
    ...
    invoke-static {v1}, Lns;->a(Ljava/lang/Runnable;)Landroid/window/OnBackInvokedCallback;
    ...
    invoke-static {v0, v1}, Lns;->c(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v0, v1}, Lns;->d(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final y()Lny;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->O:Lny;
    ...
    invoke-direct {v0, p0, v1}, Lny;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->O:Lny;
