...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lhx;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    sget-object v0, Lfw;->d:[I
    ...
    invoke-virtual {p1, p2, v1}, Landroidx/wear/ambient/AmbientDelegate;->t(II)I
    ...
    invoke-virtual {p1, p2, p3}, Landroidx/wear/ambient/AmbientDelegate;->t(II)I
...
.method public final h(Lgc;)V
    ...
    invoke-direct {v2, p1, v1}, Lhz;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Lgc;->a()Landroid/view/Menu;

    move-result-object p1

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lih;
    ...
    invoke-direct {v0, v2}, Lih;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lih;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lih;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->b:Landroid/content/Context;

    check-cast p1, Lhb;

    invoke-virtual {p1, v2, v3}, Lhb;->h(Lho;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lih;

    iget-object v2, p1, Lih;->f:Lhq;

    iget-object v3, p1, Lgr;->f:Lhq;

    if-nez v3, :cond_3

    iget-object v3, p1, Lgr;->d:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Lgr;->f:Lhq;

    iget-object v1, p1, Lgr;->f:Lhq;

    iget-object v3, p1, Lgr;->c:Lhb;

    invoke-interface {v1, v3}, Lhq;->a(Lhb;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/ActionMenuView;->k(Lih;)V
    ...
    invoke-static {p1, v1}, Lcdi;->m(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final l(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p0, p1}, Lcdx;->i(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final onDetachedFromWindow()V
    ...
    invoke-super {p0}, Lhx;->onDetachedFromWindow()V
...
.method public final bridge synthetic onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-super {p0, p1}, Lhx;->onHoverEvent(Landroid/view/MotionEvent;)Z
...
.method public final bridge synthetic onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-super {p0, p1}, Lhx;->onTouchEvent(Landroid/view/MotionEvent;)Z
