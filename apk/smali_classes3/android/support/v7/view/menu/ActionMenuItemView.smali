...
.method private final h()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lhd;
    ...
    iget-object v2, v2, Lhd;->l:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lhd;->d:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lhd;->m:Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lhd;

    iget-object v1, v0, Lhd;->d:Ljava/lang/CharSequence;

    :goto_4
    invoke-static {p0, v1}, Lnz;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    :cond_6
    invoke-static {p0, v2}, Lnz;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final d()Z
    ...
    invoke-virtual {v0}, Lhd;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final f(Lhd;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lhd;
    ...
    invoke-virtual {p0, v0, v2, v2, v2}, Ljx;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V

    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->h()V

    invoke-virtual {p1, p0}, Lhd;->f(Lhp;)Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lku;

    if-nez p1, :cond_4

    new-instance p1, Lgq;

    invoke-direct {p1, p0}, Lgq;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lku;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lha;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lhd;

    invoke-interface {p1, v0}, Lha;->b(Lhd;)Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Ljx;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected final onMeasure(II)V
    ...
    invoke-super {p0, v1, v2, v3, v4}, Ljx;->setPadding(IIII)V

    :cond_0
    invoke-super {p0, p1, p2}, Ljx;->onMeasure(II)V
    ...
    invoke-super {p0, p1, p2, v0, v1}, Ljx;->setPadding(IIII)V
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, p1}, Ljx;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lhd;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lku;
    ...
    :cond_0
    invoke-super {p0, p1}, Ljx;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public final setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Ljx;->setPadding(IIII)V
