...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Lfw;->r:[I

    const/4 v2, 0x0

    invoke-static {v0, p2, v1, p3, v2}, Landroidx/wear/ambient/AmbientDelegate;->E(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/wear/ambient/AmbientDelegate;

    move-result-object p2

    const/4 p3, 0x5

    invoke-virtual {p2, p3}, Landroidx/wear/ambient/AmbientDelegate;->v(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, p3, v0}, Landroidx/wear/ambient/AmbientDelegate;->t(II)I
    ...
    invoke-virtual {p2, p3, v2}, Landroidx/wear/ambient/AmbientDelegate;->A(IZ)Z
...
.method public final a()Lhd;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lhd;
...
.method public final f(Lhd;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lhd;
    ...
    :cond_3
    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lhd;
    ...
    :cond_a
    :goto_3
    invoke-virtual {p1}, Lhd;->t()Z

    move-result v0

    invoke-virtual {p1}, Lhd;->e()C

    if-eqz v0, :cond_b

    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lhd;

    invoke-virtual {v0}, Lhd;->t()Z
    ...
    iget-object v5, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lhd;

    invoke-virtual {v5}, Lhd;->e()C
    ...
    :cond_c
    iget-object v7, v5, Lhd;->j:Lhb;

    iget-object v7, v7, Lhb;->a:Landroid/content/Context;
    ...
    iget-object v9, v5, Lhd;->j:Lhb;

    iget-object v9, v9, Lhb;->a:Landroid/content/Context;
    ...
    invoke-static {v8, v5, v10, v9}, Lhd;->g(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v5, v3, v9}, Lhd;->g(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v5, v2, v9}, Lhd;->g(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    :cond_19
    iget-object p1, p1, Lhd;->l:Ljava/lang/CharSequence;
