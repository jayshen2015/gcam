...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {}, Ldu;->b()Landroid/media/MediaDescription$Builder;

    move-result-object v1

    invoke-static {v1, v0}, Ldu;->n(Landroid/media/MediaDescription$Builder;Ljava/lang/String;)V

    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->c:Ljava/lang/CharSequence;

    invoke-static {v1, v0}, Ldu;->p(Landroid/media/MediaDescription$Builder;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->d:Ljava/lang/CharSequence;

    invoke-static {v1, v0}, Ldu;->o(Landroid/media/MediaDescription$Builder;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->e:Ljava/lang/CharSequence;

    invoke-static {v1, v0}, Ldu;->j(Landroid/media/MediaDescription$Builder;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->f:Landroid/graphics/Bitmap;

    invoke-static {v1, v0}, Ldu;->l(Landroid/media/MediaDescription$Builder;Landroid/graphics/Bitmap;)V

    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->g:Landroid/net/Uri;

    invoke-static {v1, v0}, Ldu;->m(Landroid/media/MediaDescription$Builder;Landroid/net/Uri;)V

    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->h:Landroid/os/Bundle;

    invoke-static {v1, v0}, Ldu;->k(Landroid/media/MediaDescription$Builder;Landroid/os/Bundle;)V

    iget-object v0, p0, Landroid/support/v4/media/MediaDescriptionCompat;->i:Landroid/net/Uri;

    invoke-static {v1, v0}, Ldv;->b(Landroid/media/MediaDescription$Builder;Landroid/net/Uri;)V

    invoke-static {v1}, Ldu;->c(Landroid/media/MediaDescription$Builder;)Landroid/media/MediaDescription;
