...
# direct methods
.method constructor <init>(Lj$/time/temporal/k;Lj$/time/format/C;Lj$/time/format/y;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lj$/time/format/q;->a:Lj$/time/temporal/k;
...
.method public final b(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
    ...
    iget-object v0, p0, Lj$/time/format/q;->a:Lj$/time/temporal/k;
    ...
    invoke-interface {v1, v2}, Lj$/time/temporal/TemporalAccessor;->m(Lj$/time/temporal/n;)Ljava/lang/Object;
    ...
    iget-object v4, p0, Lj$/time/format/q;->a:Lj$/time/temporal/k;
    ...
    invoke-virtual/range {v2 .. v8}, Lj$/time/format/y;->d(Lj$/time/chrono/g;Lj$/time/temporal/k;JLj$/time/format/C;Ljava/util/Locale;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lj$/time/format/q;->a:Lj$/time/temporal/k;
    ...
    invoke-virtual/range {v1 .. v6}, Lj$/time/format/y;->e(Lj$/time/temporal/k;JLj$/time/format/C;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1, v3, v4}, Lj$/time/format/l;-><init>(Lj$/time/temporal/k;IILj$/time/format/B;)V
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/format/l;->b(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v3, p0, Lj$/time/format/q;->a:Lj$/time/temporal/k;
