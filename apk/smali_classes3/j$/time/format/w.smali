...
.method constructor <init>(Lj$/time/temporal/TemporalAccessor;Lj$/time/format/DateTimeFormatter;)V
    ...
    invoke-interface {p1, v3}, Lj$/time/temporal/TemporalAccessor;->m(Lj$/time/temporal/n;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/k;)Z
    ...
    invoke-static {p1, v1}, Lj$/time/r;->r(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/r;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/k;)I
    ...
    invoke-virtual {v7}, Lj$/time/o;->A()I
    ...
    invoke-interface {p1, v7}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/k;)Z
...
.method final e(Lj$/time/temporal/k;)Ljava/lang/Long;
    ...
    invoke-interface {v1, p1}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/k;)Z
    ...
    :cond_0
    invoke-interface {v1, p1}, Lj$/time/temporal/TemporalAccessor;->k(Lj$/time/temporal/k;)J
...
.method final f(Lj$/time/temporal/n;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Lj$/time/temporal/TemporalAccessor;->m(Lj$/time/temporal/n;)Ljava/lang/Object;

    move-result-object v1

    if-nez v1, :cond_1

    iget v2, p0, Lj$/time/format/w;->c:I
    ...
    invoke-direct {v1, p1}, Lj$/time/b;-><init>(Ljava/lang/String;)V
