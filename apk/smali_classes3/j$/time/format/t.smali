...
.method constructor <init>(Lj$/time/format/C;Z)V
    ...
    invoke-direct {p0, v0, v1}, Lj$/time/format/s;-><init>(Lj$/time/temporal/n;Ljava/lang/String;)V
...
.method public final b(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {p1, v0}, Lj$/time/format/w;->f(Lj$/time/temporal/n;)Ljava/lang/Object;
    ...
    iget-boolean v5, p0, Lj$/time/format/t;->d:Z
    ...
    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/k;)Z
    ...
    invoke-interface {v3, v8}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/k;)Z

    move-result v9

    if-eqz v9, :cond_2

    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->k(Lj$/time/temporal/k;)J
    ...
    invoke-interface {v3, v8}, Lj$/time/temporal/TemporalAccessor;->k(Lj$/time/temporal/k;)J
    ...
    invoke-static {v5, v3}, Lj$/time/i;->F(Lj$/time/g;Lj$/time/k;)Lj$/time/i;
    ...
    invoke-virtual {v5, v3}, Lj$/time/zone/c;->f(Lj$/time/i;)Lj$/time/zone/a;
    ...
    invoke-static {v3, v0, v6}, Lj$/time/r;->s(Lj$/time/i;Lj$/time/ZoneId;Lj$/time/o;)Lj$/time/r;

    move-result-object v0

    invoke-virtual {v0}, Lj$/time/r;->v()J

    move-result-wide v8

    invoke-virtual {v0}, Lj$/time/r;->B()Lj$/time/k;
    ...
    invoke-virtual {v5, v0}, Lj$/time/zone/c;->h(Lj$/time/Instant;)Z
    ...
    iget-object v5, p0, Lj$/time/format/t;->c:Lj$/time/format/C;
    ...
    :cond_6
    invoke-virtual {v5}, Lj$/time/format/C;->b()I
