...
.method constructor <init>(Lj$/time/temporal/a;IIZ)V
    ...
    invoke-direct/range {v0 .. v5}, Lj$/time/format/h;-><init>(Lj$/time/temporal/k;IIZI)V
    ...
    invoke-virtual {p4}, Lj$/time/temporal/p;->f()Z
...
.method constructor <init>(Lj$/time/temporal/k;IIZI)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lj$/time/format/l;-><init>(Lj$/time/temporal/k;IILj$/time/format/B;I)V
...
.method public final b(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
    ...
    iget-object v0, p0, Lj$/time/format/l;->a:Lj$/time/temporal/k;
    ...
    invoke-interface {v0}, Lj$/time/temporal/k;->f()Lj$/time/temporal/p;

    move-result-object v1

    invoke-virtual {v1, v3, v4, v0}, Lj$/time/temporal/p;->b(JLj$/time/temporal/k;)V

    invoke-virtual {v1}, Lj$/time/temporal/p;->e()J
    ...
    invoke-virtual {v1}, Lj$/time/temporal/p;->d()J
...
.method final d()Lj$/time/format/l;
    ...
    iget-object v3, p0, Lj$/time/format/l;->a:Lj$/time/temporal/k;
    ...
    invoke-direct/range {v2 .. v7}, Lj$/time/format/h;-><init>(Lj$/time/temporal/k;IIZI)V
...
.method final e(I)Lj$/time/format/l;
    ...
    iget-object v1, p0, Lj$/time/format/l;->a:Lj$/time/temporal/k;
