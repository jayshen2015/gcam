...
.method public final b(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
    ...
    invoke-static {v2, v4, v1}, Ljava/text/DateFormat;->getDateTimeInstance(IILjava/util/Locale;)Ljava/text/DateFormat;
    ...
    invoke-virtual {v4, v2}, Lj$/time/format/u;->k(Ljava/lang/String;)V

    invoke-virtual {v4, v1}, Lj$/time/format/u;->z(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;

    move-result-object v5

    invoke-interface {v3, v0, v5}, Ljava/util/concurrent/ConcurrentMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/format/f;->b(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
