...
.method public final b(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
    ...
    sget-object v1, Lj$/time/temporal/r;->h:Lj$/time/temporal/TemporalUnit;
    ...
    invoke-static {v1, v0}, Lj$/time/temporal/r;->f(Lj$/time/c;I)Lj$/time/temporal/r;
    ...
    invoke-virtual {v0}, Lj$/time/temporal/r;->i()Lj$/time/temporal/k;
    ...
    :cond_1
    invoke-virtual {v0}, Lj$/time/temporal/r;->c()Lj$/time/temporal/k;
    ...
    :cond_2
    invoke-virtual {v0}, Lj$/time/temporal/r;->g()Lj$/time/temporal/k;
    ...
    invoke-direct {v0, v2, v1, v3}, Lj$/time/format/o;-><init>(Lj$/time/temporal/k;Lj$/time/g;I)V
    ...
    invoke-direct/range {v1 .. v6}, Lj$/time/format/l;-><init>(Lj$/time/temporal/k;IILj$/time/format/B;I)V

    goto :goto_4

    :cond_5
    invoke-virtual {v0}, Lj$/time/temporal/r;->h()Lj$/time/temporal/k;
    ...
    :goto_4
    invoke-interface {v0, p1, p2}, Lj$/time/format/g;->b(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
