...
.field public static final f:Lj$/time/o;

.field public static final g:Lj$/time/o;

.field public static final h:Lj$/time/o;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/o;->d:Lj$/util/concurrent/ConcurrentHashMap;

    new-instance v0, Lj$/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0, v1, v2, v3}, Lj$/util/concurrent/ConcurrentHashMap;-><init>(IFI)V

    sput-object v0, Lj$/time/o;->e:Lj$/util/concurrent/ConcurrentHashMap;

    const/4 v0, 0x0

    invoke-static {v0}, Lj$/time/o;->D(I)Lj$/time/o;

    move-result-object v0

    sput-object v0, Lj$/time/o;->f:Lj$/time/o;
    ...
    sput-object v0, Lj$/time/o;->g:Lj$/time/o;
    ...
    sput-object v0, Lj$/time/o;->h:Lj$/time/o;
...
.method private constructor <init>(I)V
    ...
    :goto_3
    iput-object p1, p0, Lj$/time/o;->c:Ljava/lang/String;

    return-void
.end method

.method public static B(Ljava/lang/String;)Lj$/time/o;
    .locals 7

    if-eqz p0, :cond_a

    sget-object v0, Lj$/time/o;->e:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p0, v2, v3}, Lj$/time/o;->E(Ljava/lang/CharSequence;IZ)I

    move-result v0

    invoke-static {p0, v6, v2}, Lj$/time/o;->E(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v5, v2}, Lj$/time/o;->E(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v1, v3}, Lj$/time/o;->E(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v4, v3}, Lj$/time/o;->E(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v0, v1}, Lj$/time/o;->C(III)Lj$/time/o;
    ...
    :cond_9
    invoke-static {v0, v1, v2}, Lj$/time/o;->C(III)Lj$/time/o;
...
.method public static C(III)Lj$/time/o;
    .locals 4
...
.method public static D(I)Lj$/time/o;
    ...
    sget-object v1, Lj$/time/o;->d:Lj$/util/concurrent/ConcurrentHashMap;

    invoke-interface {v1, v0}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lj$/time/o;

    if-nez v2, :cond_0

    new-instance v2, Lj$/time/o;

    invoke-direct {v2, p0}, Lj$/time/o;-><init>(I)V
    ...
    iget-object p0, v2, Lj$/time/o;->c:Ljava/lang/String;
...
.method private static E(Ljava/lang/CharSequence;IZ)I
    .locals 2
...
.method public static z(Lj$/time/temporal/TemporalAccessor;)Lj$/time/o;
    .locals 4
...
.method public final f(Lj$/time/temporal/k;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/o;->k(Lj$/time/temporal/k;)J

    move-result-wide v1

    invoke-virtual {v0, v1, v2, p1}, Lj$/time/temporal/p;->a(JLj$/time/temporal/k;)I
...
.method public final q()Ljava/lang/String;
    ...
    iget-object v0, p0, Lj$/time/o;->c:Ljava/lang/String;
...
.method public final r()Lj$/time/zone/c;
    ...
    invoke-static {p0}, Lj$/time/zone/c;->j(Lj$/time/o;)Lj$/time/zone/c;
