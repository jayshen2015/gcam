...
public class SsljButton extends OptionButton implements View.OnClickListener {
    ...
    public void onClickPopItem(int i) {
        ...
        if(G.viewfinderCover!=null&&G.viewfinderCover.c!=null){
            ...
            ViewGroup vg=rootView.findViewById( viewfinder_frame);
            if(vg!=null ){
                 int index=vg.getChildCount();
            ...
            if(surfaceView!=null){
               GPUImage g= new GPUImage(G.CONTEXT);
    ...
    String getViewText(View v){
        ...
        for(int i=0;i<2;i++){
            if(tmpv.getParent()!=null && tmpv.getParent() instanceof View){
